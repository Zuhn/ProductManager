function RGBColor(m) {
    ...
    var c, m = m.replace(/ /g, ""), m = m.toLowerCase(), a = {
        aliceblue: "f0f8ff",
        antiquewhite: "faebd7",
        aqua: "00ffff",
        aquamarine: "7fffd4",
    ...
    for (c = 0; d.length > c; c++) {
        ...
        k && (channels = b(k), this.r = channels[0], this.g = channels[1], this.b = channels[2], 
        this.ok = !0);
    }
    this.r = 0 > this.r || isNaN(this.r) ? 0 : this.r > 255 ? 255 : this.r;
    this.g = 0 > this.g || isNaN(this.g) ? 0 : this.g > 255 ? 255 : this.g;
    this.b = 0 > this.b || isNaN(this.b) ? 0 : this.b > 255 ? 255 : this.b;
    this.toRGB = function() {
    ...
    this.getHelpXML = function() {
        for (var b = [], k = 0; d.length > k; k++) for (var c = d[k].example, j = 0; c.length > j; j++) b[b.length] = c[j];
        for (var h in a) b[b.length] = h;
        c = document.createElement("ul");
        c.setAttribute("id", "rgbcolor-examples");
        for (k = 0; b.length > k; k++) try {
...
Array.prototype.indexOf || (Array.prototype.indexOf = function(m) {
    for (var a = 0; this.length > a; a++) if (this[a] == m) return a;
    return -1;
});
...
(function() {
    function m() {
        ...
        a.ImagesLoaded = function() {
            for (var c = 0; a.Images.length > c; c++) if (!a.Images[c].loaded) return !1;
            return !0;
        };
        a.trim = function(a) {
        ...
        a.ajax = function(a) {
            var d;
            return (d = window.XMLHttpRequest ? new XMLHttpRequest() : new ActiveXObject("Microsoft.XMLHTTP")) ? (d.open("GET", a, !1), 
            d.send(null), d.responseText) : null;
        };
        ...
        a.Property = function(c, d) {
            ...
            this.Definition = {
                ...
                isUrl: function() {
                    return 0 == b.value.indexOf("url(");
                },
                getFillStyle: function(b) {
                    var d = this.getDefinition();
                    return null != d && d.createGradient ? d.createGradient(a.ctx, b) : null != d && d.createPattern ? d.createPattern(a.ctx, b) : null;
                }
            };
            this.Length = {
                DPI: function() {
                ...
                toPixels: function(d) {
                    ...
                    var c = b.value + "";
                    return c.match(/em$/) ? b.numValue() * this.EM(d) : c.match(/ex$/) ? b.numValue() * this.EM(d) / 2 : c.match(/px$/) ? b.numValue() : c.match(/pt$/) ? 1.25 * b.numValue() : c.match(/pc$/) ? 15 * b.numValue() : c.match(/cm$/) ? b.numValue() * this.DPI(d) / 2.54 : c.match(/mm$/) ? b.numValue() * this.DPI(d) / 25.4 : c.match(/in$/) ? b.numValue() * this.DPI(d) : c.match(/%$/) ? b.numValue() * a.ViewPort.ComputeSize(d) : b.numValue();
                }
            };
            this.Time = {
                toMilliseconds: function() {
                    if (!b.hasValue()) return 0;
                    var a = b.value + "";
                    if (a.match(/s$/)) return 1e3 * b.numValue();
                    a.match(/ms$/);
                    return b.numValue();
                }
            };
        ...
        a.Font = new function() {
            ...
            this.Parse = function(d) {
                for (var b = {}, d = a.trim(a.compressSpaces(d || "")).split(" "), k = !1, e = !1, f = !1, g = !1, j = "", h = 0; d.length > h; h++) if (e || -1 == c.Styles.indexOf(d[h])) if (g || -1 == c.Variants.indexOf(d[h])) if (f || -1 == c.Weights.indexOf(d[h])) if (k) "inherit" != d[h] && (j += d[h]); else {
                    "inherit" != d[h] && (b.fontSize = d[h].split("/")[0]);
                    e = g = f = k = !0;
                } else {
                    "inherit" != d[h] && (b.fontWeight = d[h]);
                    e = g = f = !0;
                } else {
                    "inherit" != d[h] && (b.fontVariant = d[h]);
                    e = g = !0;
                } else {
                    "inherit" != d[h] && (b.fontStyle = d[h]);
                    e = !0;
                }
                "" != j && (b.fontFamily = j);
                return b;
        ...
        a.ToNumberArray = function(c) {
            for (var c = a.trim(a.compressSpaces((c || "").replace(/,/g, " "))).split(" "), d = 0; c.length > d; d++) c[d] = parseFloat(c[d]);
            return c;
        };
        ...
        a.CreatePath = function(c) {
            for (var c = a.ToNumberArray(c), d = [], b = 0; c.length > b; b += 2) d.push(new a.Point(c[b], c[b + 1]));
            return d;
        };
        a.BoundingBox = function(a, d, b, k) {
            ...
            this.addPoint = function(b, a) {
                if (null != b) {
                    (isNaN(this.x1) || isNaN(this.x2)) && (this.x2 = this.x1 = b);
                    this.x1 > b && (this.x1 = b);
                    b > this.x2 && (this.x2 = b);
                }
                if (null != a) {
                    (isNaN(this.y1) || isNaN(this.y2)) && (this.y2 = this.y1 = a);
                    this.y1 > a && (this.y1 = a);
                    a > this.y2 && (this.y2 = a);
                }
            };
            ...
            this.addBezierCurve = function(b, a, d, c, k, l, o, n) {
                ...
                for (i = 0; 1 >= i; i++) b = function(b) {
                    return Math.pow(1 - b, 3) * q[i] + 3 * Math.pow(1 - b, 2) * b * p[i] + 3 * (1 - b) * Math.pow(b, 2) * t[i] + Math.pow(b, 3) * m[i];
                }, a = 6 * q[i] - 12 * p[i] + 6 * t[i], d = -3 * q[i] + 9 * p[i] - 9 * t[i] + 3 * m[i], 
                c = 3 * p[i] - 3 * q[i], 0 == d ? 0 != a && (a = -c / a, a > 0 && 1 > a && (0 == i && this.addX(b(a)), 
                1 == i && this.addY(b(a)))) : (c = Math.pow(a, 2) - 4 * c * d, 0 > c || (k = (-a + Math.sqrt(c)) / (2 * d), 
                k > 0 && 1 > k && (0 == i && this.addX(b(k)), 1 == i && this.addY(b(k))), a = (-a - Math.sqrt(c)) / (2 * d), 
                a > 0 && 1 > a && (0 == i && this.addX(b(a)), 1 == i && this.addY(b(a)))));
            };
            this.isPointInBox = function(b, a) {
                return b >= this.x1 && this.x2 >= b && a >= this.y1 && this.y2 >= a;
            };
            this.addPoint(a, d);
            this.addPoint(b, k);
        };
        a.Transform = function(c) {
            ...
            this.transforms = [];
            this.apply = function(b) {
                for (var a = 0; this.transforms.length > a; a++) this.transforms[a].apply(b);
            };
            this.applyToPoint = function(b) {
                for (var a = 0; this.transforms.length > a; a++) this.transforms[a].applyToPoint(b);
            };
            for (var c = a.trim(a.compressSpaces(c)).split(/\s(?=[a-z])/), b = 0; c.length > b; b++) {
        ...
        a.AspectRatio = function(c, d, b, k, e, f, g, j, h, l) {
            ...
            h.hasValue() && l.hasValue() ? c.translate(-p * h.Length.toPixels("x"), -p * l.Length.toPixels("y")) : (o.match(/^xMid/) && ("meet" == d && p == q || "slice" == d && m == q) && c.translate(b / 2 - k / 2, 0), 
            o.match(/YMid$/) && ("meet" == d && p == n || "slice" == d && m == n) && c.translate(0, e / 2 - f / 2), 
            o.match(/^xMax/) && ("meet" == d && p == q || "slice" == d && m == q) && c.translate(b - k, 0), 
            o.match(/YMax$/) && ("meet" == d && p == n || "slice" == d && m == n) && c.translate(0, e - f));
            "none" == o ? c.scale(n, q) : "meet" == d ? c.scale(p, p) : "slice" == d && c.scale(m, m);
            c.translate(null == g ? 0 : -g, null == j ? 0 : -j);
        };
        a.Element = {};
        a.Element.ElementBase = function(c) {
            ...
            this.style = function(b, d) {
                ...
                if (null != c) return c;
                c = this.attribute(b);
                if (null != c && c.hasValue()) return c;
                c = this.parent;
                if (null != c && (c = c.style(b), null != c && c.hasValue())) return c;
                c = new a.Property(b, "");
                d == !0 && (this.styles[b] = c);
                return c;
            };
            this.render = function(b) {
                if ("none" != this.style("display").value && "hidden" != this.attribute("visibility").value) {
                    ...
                    if (this.attribute("mask").hasValue()) {
                        ...
                        null != a && a.apply(b, this);
                    } else this.style("filter").hasValue() ? (a = this.style("filter").Definition.getDefinition(), 
                    null != a && a.apply(b, this)) : this.renderChildren(b);
                    this.clearContext(b);
                    b.restore();
                }
            };
            ...
            this.renderChildren = function(b) {
                for (var a = 0; this.children.length > a; a++) this.children[a].render(b);
            };
            ...
            if (null != c && 1 == c.nodeType) {
                for (var d = 0; c.childNodes.length > d; d++) {
                    var b = c.childNodes[d];
                    1 == b.nodeType && this.addChild(b, !0);
                }
                for (d = 0; c.attributes.length > d; d++) b = c.attributes[d], this.attributes[b.nodeName] = new a.Property(b.nodeName, b.nodeValue);
                b = a.Styles[c.nodeName];
                if (null != b) for (var k in b) this.styles[k] = b[k];
                if (this.attribute("class").hasValue()) for (var d = a.compressSpaces(this.attribute("class").value).split(" "), e = 0; d.length > e; e++) {
                    b = a.Styles["." + d[e]];
                    if (null != b) for (k in b) this.styles[k] = b[k];
                    b = a.Styles[c.nodeName + "." + d[e]];
                    if (null != b) for (k in b) this.styles[k] = b[k];
                }
                if (this.attribute("style").hasValue()) {
                    b = this.attribute("style").value.split(";");
                    for (d = 0; b.length > d; d++) "" != a.trim(b[d]) && (c = b[d].split(":"), k = a.trim(c[0]), 
                    c = a.trim(c[1]), this.styles[k] = new a.Property(k, c));
                }
        ...
        a.Element.RenderedElementBase = function(c) {
            ...
            this.setContext = function(d) {
                if (this.style("fill").Definition.isUrl()) {
                    ...
                    null != b && (d.fillStyle = b);
                } else this.style("fill").hasValue() && (b = this.style("fill"), this.style("fill-opacity").hasValue() && (b = b.Color.addOpacity(this.style("fill-opacity").value)), 
                d.fillStyle = "none" == b.value ? "rgba(0,0,0,0)" : b.value);
                this.style("stroke").Definition.isUrl() ? (b = this.style("stroke").Definition.getFillStyle(this), 
                null != b) && (d.strokeStyle = b) : this.style("stroke").hasValue() && (b = this.style("stroke"), 
                this.style("stroke-opacity").hasValue() && (b = b.Color.addOpacity(this.style("stroke-opacity").value)), 
                d.strokeStyle = "none" == b.value ? "rgba(0,0,0,0)" : b.value);
                this.style("stroke-width").hasValue() && (d.lineWidth = this.style("stroke-width").Length.toPixels());
                this.style("stroke-linecap").hasValue() && (d.lineCap = this.style("stroke-linecap").value);
                this.style("stroke-linejoin").hasValue() && (d.lineJoin = this.style("stroke-linejoin").value);
                this.style("stroke-miterlimit").hasValue() && (d.miterLimit = this.style("stroke-miterlimit").value);
                "undefined" != typeof d.font && (d.font = a.Font.CreateFont(this.style("font-style").value, this.style("font-variant").value, this.style("font-weight").value, this.style("font-size").hasValue() ? this.style("font-size").Length.toPixels() + "px" : "", this.style("font-family").value).toString());
                this.attribute("transform").hasValue() && new a.Transform(this.attribute("transform").value).apply(d);
                this.attribute("clip-path").hasValue() && (b = this.attribute("clip-path").Definition.getDefinition(), 
                null != b && b.apply(d));
                this.style("opacity").hasValue() && (d.globalAlpha = this.style("opacity").numValue());
            };
        };
        ...
        a.Element.PathElementBase = function(c) {
            ...
            this.renderChildren = function(d) {
                ...
                if (null != b) {
                    ...
                    if (this.style("marker-mid").Definition.isUrl()) for (var c = this.style("marker-mid").Definition.getDefinition(), e = 1; b.length - 1 > e; e++) c.render(d, b[e][0], b[e][1]);
                    this.style("marker-end").Definition.isUrl() && (c = this.style("marker-end").Definition.getDefinition(), 
        ...
        a.Element.rect = function(c) {
            ...
            this.path = function(d) {
                ...
                null != d && (d.beginPath(), d.moveTo(b + g, c), d.lineTo(b + e - g, c), d.quadraticCurveTo(b + e, c, b + e, c + j), 
                d.lineTo(b + e, c + f - j), d.quadraticCurveTo(b + e, c + f, b + e - g, c + f), 
                d.lineTo(b + g, c + f), d.quadraticCurveTo(b, c + f, b, c + f - j), d.lineTo(b, c + j), 
                d.quadraticCurveTo(b, c, b + g, c), d.closePath());
        ...
        a.Element.circle = function(c) {
            ...
            this.path = function(d) {
                ...
                null != d && (d.beginPath(), d.arc(b, c, e, 0, 2 * Math.PI, !0), d.closePath());
        ...
        a.Element.ellipse = function(c) {
            ...
            this.path = function(d) {
                ...
                null != d && (d.beginPath(), d.moveTo(f, g - e), d.bezierCurveTo(f + b * c, g - e, f + c, g - b * e, f + c, g), 
                d.bezierCurveTo(f + c, g + b * e, f + b * c, g + e, f, g + e), d.bezierCurveTo(f - b * c, g + e, f - c, g + b * e, f - c, g), 
                d.bezierCurveTo(f - c, g - b * e, f - b * c, g - e, f, g - e), d.closePath());
        ...
        a.Element.line = function(c) {
            ...
            this.path = function(d) {
                ...
                null != d && (d.beginPath(), d.moveTo(b[0].x, b[0].y), d.lineTo(b[1].x, b[1].y));
        ...
        a.Element.polyline = function(c) {
            ...
            this.path = function(d) {
                ...
                for (var c = 1; this.points.length > c; c++) b.addPoint(this.points[c].x, this.points[c].y), 
                null != d && d.lineTo(this.points[c].x, this.points[c].y);
                return b;
            };
            this.getMarkers = function() {
                for (var a = [], b = 0; this.points.length - 1 > b; b++) a.push([ this.points[b], this.points[b].angleTo(this.points[b + 1]) ]);
        ...
        a.Element.path = function(c) {
            ...
            this.PathParser = new function(d) {
                ...
                this.makeAbsolute = function(b) {
                    this.isRelativeCommand() && (b.x = this.current.x + b.x, b.y = this.current.y + b.y);
                    return b;
                };
                this.addMarker = function(b, a, d) {
                    null != d && this.angles.length > 0 && null == this.angles[this.angles.length - 1] && (this.angles[this.angles.length - 1] = this.points[this.points.length - 1].angleTo(d));
                    this.addMarkerAngle(b, null == a ? null : a.angleTo(b));
                };
                ...
                this.getMarkerAngles = function() {
                    for (var b = 0; this.angles.length > b; b++) if (null == this.angles[b]) for (var a = b + 1; this.angles.length > a; a++) if (null != this.angles[a]) {
            ...
            this.path = function(d) {
                ...
                for (null != d && d.beginPath(); !b.isEnd(); ) switch (b.nextCommand(), b.command.toUpperCase()) {
                  case "M":
                    var e = b.getAsCurrentPoint();
                    b.addMarker(e);
                    c.addPoint(e.x, e.y);
                    null != d && d.moveTo(e.x, e.y);
                    for (b.start = b.current; !b.isCommandOrEnd(); ) e = b.getAsCurrentPoint(), b.addMarker(e, b.start), 
                    c.addPoint(e.x, e.y), null != d && d.lineTo(e.x, e.y);
                    break;
                  ...
                  case "L":
                    for (;!b.isCommandOrEnd(); ) {
                        ...
                        b.addMarker(e, f);
                        c.addPoint(e.x, e.y);
                        null != d && d.lineTo(e.x, e.y);
                    }
                    break;

                  case "H":
                    for (;!b.isCommandOrEnd(); ) e = new a.Point((b.isRelativeCommand() ? b.current.x : 0) + b.getScalar(), b.current.y), 
                    b.addMarker(e, b.current), b.current = e, c.addPoint(b.current.x, b.current.y), 
                    null != d && d.lineTo(b.current.x, b.current.y);
                    break;
                  ...
                  case "C":
                    for (;!b.isCommandOrEnd(); ) {
                        ...
                        null != d && d.bezierCurveTo(f.x, f.y, j.x, j.y, e.x, e.y);
                    }
                    break;

                  case "S":
                    for (;!b.isCommandOrEnd(); ) g = b.current, f = b.getReflectedControlPoint(), j = b.getAsControlPoint(), 
                    e = b.getAsCurrentPoint(), b.addMarker(e, j, f), c.addBezierCurve(g.x, g.y, f.x, f.y, j.x, j.y, e.x, e.y), 
                    null != d && d.bezierCurveTo(f.x, f.y, j.x, j.y, e.x, e.y);
                    break;

                  case "Q":
                    for (;!b.isCommandOrEnd(); ) g = b.current, j = b.getAsControlPoint(), e = b.getAsCurrentPoint(), 
                    b.addMarker(e, j, j), c.addQuadraticCurve(g.x, g.y, j.x, j.y, e.x, e.y), null != d && d.quadraticCurveTo(j.x, j.y, e.x, e.y);
                    break;

                  case "T":
                    for (;!b.isCommandOrEnd(); ) g = b.current, j = b.getReflectedControlPoint(), b.control = j, 
                    e = b.getAsCurrentPoint(), b.addMarker(e, j, j), c.addQuadraticCurve(g.x, g.y, j.x, j.y, e.x, e.y), 
                    null != d && d.quadraticCurveTo(j.x, j.y, e.x, e.y);
                    break;
                  ...
                  case "A":
                    for (;!b.isCommandOrEnd(); ) {
                        ...
                        b.addMarkerAngle(q, (o + n) / 2 + (0 == j ? 1 : -1) * Math.PI / 2);
                        b.addMarkerAngle(e, n + (0 == j ? 1 : -1) * Math.PI / 2);
                        c.addPoint(e.x, e.y);
                        null != d && (m = h > l ? h : l, e = h > l ? 1 : h / l, h = h > l ? l / h : 1, d.translate(g.x, g.y), 
                        d.rotate(f), d.scale(e, h), d.arc(0, 0, m, o, o + n, 1 - j), d.scale(1 / e, 1 / h), 
                        d.rotate(-f), d.translate(-g.x, -g.y));
                    }
                    break;

                  case "Z":
                    null != d && d.closePath(), b.current = b.start;
                }
                return c;
            };
            this.getMarkers = function() {
                for (var a = this.PathParser.getMarkerPoints(), b = this.PathParser.getMarkerAngles(), c = [], e = 0; a.length > e; e++) c.push([ a[e], b[e] ]);
                return c;
            };
        };
        ...
        a.Element.marker = function(c) {
            ...
            this.render = function(d, b, c) {
                d.translate(b.x, b.y);
                "auto" == this.attribute("orient").valueOrDefault("auto") && d.rotate(c);
                "strokeWidth" == this.attribute("markerUnits").valueOrDefault("strokeWidth") && d.scale(d.lineWidth, d.lineWidth);
                d.save();
                ...
                e.render(d);
                d.restore();
                "strokeWidth" == this.attribute("markerUnits").valueOrDefault("strokeWidth") && d.scale(1 / d.lineWidth, 1 / d.lineWidth);
                "auto" == this.attribute("orient").valueOrDefault("auto") && d.rotate(-c);
                d.translate(-b.x, -b.y);
            };
        };
        ...
        a.Element.GradientBase = function(c) {
            ...
            this.stops = [];
            for (c = 0; this.children.length > c; c++) this.stops.push(this.children[c]);
            ...
            this.createGradient = function(d, b) {
                ...
                for (var e = this.getGradient(d, b), f = 0; c.stops.length > f; f++) e.addColorStop(c.stops[f].offset, c.stops[f].color);
        ...
        a.Element.radialGradient = function(c) {
            ...
            this.base(c);
            this.getGradient = function(a, b) {
                var c = b.getBoundingBox(), e = "objectBoundingBox" == this.gradientUnits ? c.x() + c.width() * this.attribute("cx").numValue() : this.attribute("cx").Length.toPixels("x"), f = "objectBoundingBox" == this.gradientUnits ? c.y() + c.height() * this.attribute("cy").numValue() : this.attribute("cy").Length.toPixels("y"), g = e, j = f;
                this.attribute("fx").hasValue() && (g = "objectBoundingBox" == this.gradientUnits ? c.x() + c.width() * this.attribute("fx").numValue() : this.attribute("fx").Length.toPixels("x"));
                this.attribute("fy").hasValue() && (j = "objectBoundingBox" == this.gradientUnits ? c.y() + c.height() * this.attribute("fy").numValue() : this.attribute("fy").Length.toPixels("y"));
        ...
        a.Element.AnimateBase = function(c) {
            ...
            this.update = function(a) {
                null == this.initialValue && (this.initialValue = this.getProperty().value);
                if (this.duration > this.maxDuration) {
                    if ("indefinite" != this.attribute("repeatCount").value) return "remove" != this.attribute("fill").valueOrDefault("remove") || this.removed ? !1 : (this.removed = !0, 
                    this.getProperty().value = this.initialValue, !0);
                    this.duration = 0;
                }
                this.duration += a;
                a = !1;
                this.begin < this.duration && (a = this.calcValue(), this.attribute("type").hasValue() && (a = this.attribute("type").value + "(" + a + ")"), 
        ...
        a.Element.font = function(c) {
            ...
            this.glyphs = [];
            for (c = 0; this.children.length > c; c++) {
                var d = this.children[c];
                "font-face" == d.type ? (this.fontFace = d, d.style("font-family").hasValue() && (a.Definitions[d.style("font-family").value] = this)) : "missing-glyph" == d.type ? this.missingGlyph = d : "glyph" == d.type && ("" != d.arabicForm ? (this.isArabic = this.isRTL = !0, 
                "undefined" == typeof this.glyphs[d.unicode] && (this.glyphs[d.unicode] = []), this.glyphs[d.unicode][d.arabicForm] = d) : this.glyphs[d.unicode] = d);
            }
        };
        ...
        a.Element.text = function(c) {
            ...
            if (null != c) {
                ...
                for (var d = 0; c.childNodes.length > d; d++) {
                    var b = c.childNodes[d];
                    1 == b.nodeType ? this.addChild(b, !0) : 3 == b.nodeType && this.addChild(new a.Element.tspan(b), !1);
                }
            }
            this.baseSetContext = this.setContext;
            this.setContext = function(b) {
                this.baseSetContext(b);
                this.style("dominant-baseline").hasValue() && (b.textBaseline = this.style("dominant-baseline").value);
                this.style("alignment-baseline").hasValue() && (b.textBaseline = this.style("alignment-baseline").value);
            };
            this.renderChildren = function(b) {
                for (var a = this.style("text-anchor").valueOrDefault("start"), c = this.attribute("x").Length.toPixels("x"), d = this.attribute("y").Length.toPixels("y"), j = 0; this.children.length > j; j++) {
                    var h = this.children[j];
                    h.attribute("x").hasValue() ? h.x = h.attribute("x").Length.toPixels("x") : (h.attribute("dx").hasValue() && (c += h.attribute("dx").Length.toPixels("x")), 
                    h.x = c);
                    c = h.measureText(b);
                    if ("start" != a && (0 == j || h.attribute("x").hasValue())) {
                        for (var l = c, o = j + 1; this.children.length > o; o++) {
                    ...
                    c = h.x + c;
                    h.attribute("y").hasValue() ? h.y = h.attribute("y").Length.toPixels("y") : (h.attribute("dy").hasValue() && (d += h.attribute("dy").Length.toPixels("y")), 
                    h.y = d);
                    d = h.y;
                    h.render(b);
                }
        ...
        a.Element.TextElementBase = function(c) {
            ...
            this.getGlyph = function(a, b, c) {
                ...
                if (a.isArabic) {
                    var g = "isolated";
                    (0 == c || " " == b[c - 1]) && b.length - 2 > c && " " != b[c + 1] && (g = "terminal");
                    c > 0 && " " != b[c - 1] && b.length - 2 > c && " " != b[c + 1] && (g = "medial");
                    c > 0 && " " != b[c - 1] && (c == b.length - 1 || " " == b[c + 1]) && (g = "initial");
            ...
            this.renderChildren = function(c) {
                ...
                if (null != b) {
                    ...
                    for (var g = a.ToNumberArray(this.parent.attribute("dx").value), j = 0; f.length > j; j++) {
                        var h = this.getGlyph(b, f, j), l = k / b.fontFace.unitsPerEm;
                        c.translate(this.x, this.y);
                        c.scale(l, -l);
                        var o = c.lineWidth;
                        c.lineWidth = c.lineWidth * b.fontFace.unitsPerEm / k;
                        "italic" == e && c.transform(1, 0, .4, 1, 0, 0);
                        h.render(c);
                        "italic" == e && c.transform(1, 0, -.4, 1, 0, 0);
                        c.lineWidth = o;
                        c.scale(1 / l, -1 / l);
                        ...
                        "undefined" != typeof g[j] && !isNaN(g[j]) && (this.x += g[j]);
                    }
            ...
            this.measureText = function(c) {
                ...
                if (null != b) {
                    ...
                    for (var f = a.ToNumberArray(this.parent.attribute("dx").value), g = 0; e.length > g; g++) {
                        var j = this.getGlyph(b, e, g);
                        k += (j.horizAdvX || b.horizAdvX) * c / b.fontFace.unitsPerEm;
                        "undefined" != typeof f[g] && !isNaN(f[g]) && (k += f[g]);
                    }
                    return k;
                }
                b = a.compressSpaces(this.getText());
                if (!c.measureText) return 10 * b.length;
                c.save();
                this.setContext(c);
        ...
        a.Element.tspan = function(c) {
            ...
            this.base(c);
            this.text = 3 == c.nodeType ? c.nodeValue : c.childNodes.length > 0 ? c.childNodes[0].nodeValue : c.text;
            this.getText = function() {
                return this.text;
            };
        };
        ...
        a.Element.a = function(c) {
            ...
            this.base(c);
            this.hasText = !0;
            for (var d = 0; c.childNodes.length > d; d++) 3 != c.childNodes[d].nodeType && (this.hasText = !1);
        ...
        a.Element.image = function(c) {
            ...
            this.renderChildren = function(b) {
                ...
                0 == f || 0 == g || (b.save(), b.translate(c, d), a.AspectRatio(b, this.attribute("preserveAspectRatio").value, f, this.img.width, g, this.img.height, 0, 0), 
        ...
        a.Element.g = function(c) {
            ...
            this.base(c);
            this.getBoundingBox = function() {
                for (var c = new a.BoundingBox(), b = 0; this.children.length > b; b++) c.addBoundingBox(this.children[b].getBoundingBox());
                return c;
            };
        };
        ...
        a.Element.style = function(c) {
            this.base = a.Element.ElementBase;
            this.base(c);
            for (var c = c.childNodes[0].nodeValue + (c.childNodes.length > 1 ? c.childNodes[1].nodeValue : ""), c = c.replace(/(\/\*([^*]|[\r\n]|(\*+([^*\/]|[\r\n])))*\*+\/)|(^[\s]*\/\/.*)/gm, ""), c = a.compressSpaces(c), c = c.split("}"), d = 0; c.length > d; d++) if ("" != a.trim(c[d])) for (var b = c[d].split("{"), k = b[0].split(","), b = b[1].split(";"), e = 0; k.length > e; e++) {
                var f = a.trim(k[e]);
                if ("" != f) {
                    for (var g = {}, j = 0; b.length > j; j++) {
                        var h = b[j].indexOf(":"), l = b[j].substr(0, h), h = b[j].substr(h + 1, b[j].length - h);
                        null != l && null != h && (g[a.trim(l)] = new a.Property(a.trim(l), a.trim(h)));
                    }
                    a.Styles[f] = g;
                    if ("@font-face" == f) {
                        f = g["font-family"].value.replace(/"/g, "");
                        g = g.src.value.split(",");
                        for (j = 0; g.length > j; j++) if (g[j].indexOf('format("svg")') > 0) {
                            l = g[j].indexOf("url");
                            h = g[j].indexOf(")", l);
        ...
        a.Element.clipPath = function(c) {
            ...
            this.apply = function(a) {
                for (var b = 0; this.children.length > b; b++) this.children[b].path && (this.children[b].path(a), 
                a.clip());
            };
            this.render = function() {};
        };
        ...
        a.Element.filter = function(c) {
            ...
            this.apply = function(a, b) {
                ...
                (0 == e || 0 == f) && (e = c.x1, f = c.y1);
                var g = this.attribute("width").Length.toPixels("x"), j = this.attribute("height").Length.toPixels("y");
                (0 == g || 0 == j) && (g = c.width(), j = c.height());
                c = b.style("filter").value;
                b.style("filter").value = "";
                var h = .2 * g, l = .2 * j, o = document.createElement("canvas");
                o.width = g + 2 * h;
                o.height = j + 2 * l;
                var n = o.getContext("2d");
                n.translate(-e + h, -f + l);
                b.render(n);
                for (var q = 0; this.children.length > q; q++) this.children[q].apply(n, 0, 0, g + 2 * h, j + 2 * l);
        ...
        a.Element.feGaussianBlur = function(c) {
            function d(a, c, d, f, g) {
                for (var j = 0; g > j; j++) for (var h = 0; f > h; h++) for (var l = a[4 * j * f + 4 * h + 3] / 255, o = 0; 4 > o; o++) {
                    for (var n = d[0] * (0 == l ? 255 : a[4 * j * f + 4 * h + o]) * (0 == l || 3 == o ? 1 : l), q = 1; d.length > q; q++) {
                        var r, p = Math.max(h - q, 0), m = a[4 * j * f + 4 * p + 3] / 255, p = Math.min(h + q, f - 1), p = a[4 * j * f + 4 * p + 3] / 255, s = d[q];
                        0 == m ? r = 255 : (r = Math.max(h - q, 0), r = a[4 * j * f + 4 * r + o]);
                        m = r * (0 == m || 3 == o ? 1 : m);
                        0 == p ? r = 255 : (r = Math.min(h + q, f - 1), r = a[4 * j * f + 4 * r + o]);
                        n += s * (m + r * (0 == p || 3 == o ? 1 : p));
                    }
                    c[4 * h * g + 4 * j + o] = n;
                }
            ...
            this.apply = function(a, c, e, f, g) {
                var e = this.attribute("stdDeviation").numValue(), c = a.getImageData(0, 0, f, g), e = Math.max(e, .01), j = Math.ceil(4 * e) + 1;
                mask = [];
                for (var h = 0; j > h; h++) mask[h] = Math.exp(-.5 * (h / e) * (h / e));
                e = mask;
                j = 0;
                for (h = 1; e.length > h; h++) j += Math.abs(e[h]);
                j = 2 * j + Math.abs(e[0]);
                for (h = 0; e.length > h; h++) e[h] /= j;
                tmp = [];
                d(c.data, tmp, e, f, g);
                d(tmp, c.data, e, g, f);
                a.clearRect(0, 0, f, g);
        ...
        a.CreateElement = function(c) {
            var d = c.nodeName.replace(/^[^:]+:/, ""), d = d.replace(/\-/g, ""), b = null, b = "undefined" != typeof a.Element[d] ? new a.Element[d](c) : new a.Element.MISSING(c);
            b.type = c.nodeName;
            return b;
        };
        a.load = function(c, d) {
        ...
        a.loadXmlDoc = function(c, d) {
            ...
            a.opts.ignoreMouse != !0 && (c.canvas.onclick = function(c) {
                c = b(new a.Point(null != c ? c.clientX : event.clientX, null != c ? c.clientY : event.clientY));
            ...
            var k = a.CreateElement(d.documentElement), e = k.root = !0, f = function() {
                ...
                if (a.opts.ignoreDimensions != !0) {
                    k.style("width").hasValue() && (c.canvas.width = k.style("width").Length.toPixels("x"), 
                    c.canvas.style.width = c.canvas.width + "px");
                    k.style("height").hasValue() && (c.canvas.height = k.style("height").Length.toPixels("y"), 
                ...
                null != a.opts && null != a.opts.offsetX && (k.attribute("x", !0).value = a.opts.offsetX);
                null != a.opts && null != a.opts.offsetY && (k.attribute("y", !0).value = a.opts.offsetY);
                if (null != a.opts && null != a.opts.scaleWidth && null != a.opts.scaleHeight) {
                    var f = 1, g = 1;
                ...
                k.render(c);
                e && (e = !1, null != a.opts && "function" == typeof a.opts.renderCallback && a.opts.renderCallback());
            }, g = !0;
            ...
            a.intervalID = setInterval(function() {
                ...
                if (a.opts.ignoreAnimation != !0) for (var c = 0; a.Animations.length > c; c++) b |= a.Animations[c].update(1e3 / a.FRAMERATE);
                null != a.opts && "function" == typeof a.opts.forceRedraw && a.opts.forceRedraw() == !0 && (b = !0);
        ...
        a.Mouse = new function() {
            ...
            this.checkPath = function(a, d) {
                for (var b = 0; this.events.length > b; b++) {
                    var k = this.events[b];
            ...
            this.runEvents = function() {
                ...
                for (var c = 0; this.events.length > c; c++) for (var d = this.events[c], b = this.eventElements[c]; b; ) d.run(b), 
                b = b.parent;
                this.events = [];
                this.eventElements = [];
            };
    ...
    this.canvg = function(a, c, d) {
        if (null == a && null == c && null == d) for (var c = document.getElementsByTagName("svg"), b = 0; c.length > b; b++) {
            a = c[b];
            ...
            k.appendChild(a);
            canvg(d, k.innerHTML);
        } else d = d || {}, "string" == typeof a && (a = document.getElementById(a)), null == a.svg ? (b = m(), 
        a.svg = b) : (b = a.svg, b.stop()), b.opts = d, a = a.getContext("2d"), "undefined" != typeof c.documentElement ? b.loadXmlDoc(a, c) : "<" == c.substr(0, 1) ? b.loadXml(a, c) : b.load(a, c);
    };
})();

CanvasRenderingContext2D && (CanvasRenderingContext2D.prototype.drawSvg = function(m, a, c, d, b) {
    canvg(this.canvas, m, {
        ignoreMouse: !0,
        ignoreAnimation: !0,
        ignoreDimensions: !0,
    ...
    b(c.prototype, {
        ...
        configure: function(b) {
            ...
            e(b, "tooltipRefresh", function(d) {
                var k, e = b.container, f = e.offsetLeft, e = e.offsetTop;
                g.innerHTML = d.text;
                ...
                void 0 !== c.ttTimer && clearTimeout(c.ttTimer);
        ...
        destroy: function() {
            g(this.canvas);
            void 0 !== this.ttTimer && clearTimeout(this.ttTimer);
            g(this.ttLine);
            g(this.ttDiv);
            g(this.hiddenSvg);
