(function(g) {
    var j = g.Axis, x = g.Chart, o = g.Color, y = g.Legend, s = g.LegendSymbolMixin, t = g.Series, u = g.getOptions(), k = g.each, p = g.extend, z = g.extendClass, l = g.merge, q = g.pick, v = g.numberFormat, m = g.seriesTypes, w = g.wrap, n = function() {}, r = g.ColorAxis = function() {
        this.isColorAxis = !0;
    ...
    p(r.prototype, {
        ...
        init: function(b, a) {
            var c, d = "vertical" !== b.options.legend.layout;
        ...
        tweenColors: function(b, a, d) {
            ...
            return (c ? "rgba(" : "rgb(") + Math.round(a.rgba[0] + (b.rgba[0] - a.rgba[0]) * (1 - d)) + "," + Math.round(a.rgba[1] + (b.rgba[1] - a.rgba[1]) * (1 - d)) + "," + Math.round(a.rgba[2] + (b.rgba[2] - a.rgba[2]) * (1 - d)) + (c ? "," + (a.rgba[3] + (b.rgba[3] - a.rgba[3]) * (1 - d)) : "") + ")";
        },
        initDataClasses: function(b) {
            var c, a = this, d = this.chart, e = 0, h = this.options;
            this.dataClasses = c = [];
            k(b.dataClasses, function(f, i) {
                var g, f = l(f);
                c.push(f);
                f.color || ("category" === h.dataClassColor ? (g = d.options.colors, f.color = g[e++], 
                e === g.length && (e = 0)) : f.color = a.tweenColors(o(h.minColor), o(h.maxColor), i / (b.dataClasses.length - 1)));
            });
        },
        ...
        setAxisSize: function() {
            var d, c, e, b = this.legendSymbol, a = this.chart;
            b && (this.left = d = b.attr("x"), this.top = c = b.attr("y"), this.width = e = b.attr("width"), 
            this.height = b = b.attr("height"), this.right = a.chartWidth - d - e, this.bottom = a.chartHeight - c - b, 
            this.len = this.horiz ? e : b, this.pos = this.horiz ? d : c);
        },
        toColor: function(b, a) {
            var d, e, f, i, c = this.stops, h = this.dataClasses;
            if (h) {
                for (i = h.length; i--; ) if (f = h[i], e = f.from, c = f.to, (void 0 === e || b >= e) && (void 0 === c || c >= b)) {
                    d = f.color;
                    a && (a.dataClass = i);
                    break;
                }
        ...
        getOffset: function() {
            ...
            b && (j.prototype.getOffset.call(this), !this.axisGroup.parentGroup) && (this.axisGroup.add(b), 
            this.gridGroup.add(b), this.labelGroup.add(b), this.added = !0);
        },
        ...
        drawLegendSymbol: function(b, a) {
            ...
            this.setLegendColor();
            a.legendSymbol = this.chart.renderer.rect(0, b.baseline - 11, h, f).attr({
                zIndex: 1
            }).add(a.legendGroup);
        ...
        getSeriesExtremes: function() {
            var b;
            this.series.length && (b = this.series[0], this.dataMin = b.valueMin, this.dataMax = b.valueMax);
        },
        drawCrosshair: function(b, a) {
            var h, d = !this.cross, c = a && a.plotX, e = a && a.plotY, f = this.pos, i = this.len;
            a && (h = this.toPixels(a.value), f > h ? h = f - 2 : h > f + i && (h = f + i + 2), 
            a.plotX = h, a.plotY = this.len - h, j.prototype.drawCrosshair.call(this, b, a), 
            a.plotX = c, a.plotY = e, !d && this.cross && this.cross.attr({
        ...
        getDataClassLegendSymbols: function() {
            var f, b = this, a = this.chart, d = [], c = a.options.legend, e = c.valueDecimals, h = c.valueSuffix || "";
            k(this.dataClasses, function(c, g) {
                var j = !0, l = c.from, m = c.to;
                f = "";
                void 0 === l ? f = "< " : void 0 === m && (f = "> ");
                void 0 !== l && (f += v(l, e) + h);
                void 0 !== l && void 0 !== m && (f += " - ");
                void 0 !== m && (f += v(m, e) + h);
                d.push(p({
    ...
    w(y.prototype, "getAllItems", function(b) {
        ...
        d && (d.options.dataClasses ? a = a.concat(d.getDataClassLegendSymbols()) : a.push(d), 
    ...
    g = {
        ...
        translateColors: function() {
            ...
            k(this.data, function(c) {
                var e = c.value;
                (e = null === e ? a : d ? d.toColor(e, c) : c.color || b.color) && (c.color = e);
            });
        }
    };
