(function(c) {
    function x(e, a, b, d) {
        ...
        j = d.x;
        o = d.y;
        t = (0 === d.z ? 1e-4 : d.z) * (d.vd || 25);
        var r, u, s, y = k(b), v = l(b), m = k(a), q = l(a);
        c.each(e, function(a) {
            r = a.x - j;
            u = a.y - o;
            s = a.z || 0;
    ...
    function z(e, a, b, d, f, c, h, i) {
        var j = [];
        return c > f && c - f > m / 2 + 1e-4 ? (j = j.concat(z(e, a, b, d, f, f + m / 2, h, i)), 
        j = j.concat(z(e, a, b, d, f + m / 2, c, h, i))) : f > c && f - c > m / 2 + 1e-4 ? (j = j.concat(z(e, a, b, d, f, f - m / 2, h, i)), 
        j = j.concat(z(e, a, b, d, f - m / 2, c, h, i))) : (j = c - f, [ "C", e + b * l(f) - b * D * j * k(f) + h, a + d * k(f) + d * D * j * l(f) + i, e + b * l(c) + b * D * j * k(c) + h, a + d * k(c) - d * D * j * l(c) + i, e + b * l(c) + h, a + d * k(c) + i ]);
    }
    function F(e) {
        if (this.chart.is3d()) {
            var a = this.chart.options.plotOptions.column.grouping;
            void 0 !== a && !a && void 0 !== this.group.zIndex && this.group.attr({
    ...
    c.SVGRenderer.prototype.cuboid = function(e) {
        ...
        a.fillSetter = function(a) {
            var d = c.Color(a).brighten(.1).get(), e = c.Color(a).brighten(-.1).get();
            this.front.attr({
                fill: a
            });
            this.top.attr({
        ...
        a.animate = function(a, d, e) {
            a.x && a.y ? (a = this.renderer.cuboidPath(a), this.front.attr({
                ...
                d: a[2]
            }, d, e)) : a.opacity ? (this.front.animate(a, d, e), this.top.animate(a, d, e), 
            this.side.animate(a, d, e)) : c.SVGElement.prototype.animate.call(this, a, d, e);
            return this;
        };
        a.destroy = function() {
            this.front.destroy();
    ...
    c.SVGRenderer.prototype.arc3d = function(e) {
        e.alpha *= n;
        e.beta *= n;
        var a = this.g(), b = this.arc3dPath(e), d = a.renderer, f = 100 * b.zAll;
        a.shapeArgs = e;
        ...
        a.fillSetter = function(a) {
            this.color = a;
            var b = c.Color(a).brighten(-.1).get();
            this.side1.attr({
                fill: b
            });
            this.side2.attr({
        ...
        a.animate = function(a, b, d) {
            ...
            a.x && a.y && (b = this.renderer, a = c.splat(a)[0], a.alpha *= n, a.beta *= n, 
            b = b.arc3dPath(a), this.shapeArgs = a, this.inn.attr({
                d: b.inn,
                zIndex: b.zInn
            }), this.out.attr({
                d: b.out,
    ...
    c.wrap(c.Axis.prototype, "init", function(e) {
        var a = arguments;
        a[1].is3d() && (a[2].tickWidth = c.pick(a[2].tickWidth, 0), a[2].gridLineWidth = c.pick(a[2].gridLineWidth, 1));
        e.apply(this, [].slice.call(arguments, 1));
    });
    c.wrap(c.Axis.prototype, "render", function(c) {
        c.apply(this, [].slice.call(arguments, 1));
        if (this.chart.is3d()) {
            var a = this.chart, b = a.renderer, d = a.options.chart.options3d, f = d.alpha, g = d.beta * (a.yAxis[0].opposite ? -1 : 1), h = d.frame, i = h.bottom, j = h.back, h = h.side, o = d.depth, k = this.height, l = this.width, m = this.left, n = this.top, d = {
    ...
    c.wrap(c.seriesTypes.column.prototype, "translate", function(e) {
        ...
        if (this.chart.is3d()) {
            var a = this.chart, b = a.options, d = b.plotOptions[this.chart.options.chart.type], b = b.chart.options3d, f = d.depth || 25, g = {
                ...
                z: b.depth,
                vd: b.viewDistance
            }, h = b.alpha, i = b.beta * (a.yAxis[0].opposite ? -1 : 1), j = (d.stacking ? this.options.stack || 0 : this._i) * (f + (d.groupZPadding || 1));
            d.grouping !== !1 && (j = 0);
            j += d.groupZPadding || 1;
            c.each(this.data, function(a) {
    ...
    c.wrap(c.seriesTypes.column.prototype, "animate", function(e) {
        if (this.chart.is3d()) {
            ...
            c.svg && (a ? c.each(d.data, function(a) {
                a.height = a.shapeArgs.height;
                a.shapeArgs.height = 1;
                f || (a.shapeArgs.y = a.stackY ? a.plotY + b.translate(a.stackY) : a.plotY + (a.negative ? -a.height : a.height));
            }) : (c.each(d.data, function(a) {
                a.shapeArgs.height = a.height;
                f || (a.shapeArgs.y = a.plotY - (a.negative ? a.height : 0));
    ...
    c.wrap(c.seriesTypes.column.prototype, "init", function(c) {
        c.apply(this, [].slice.call(arguments, 1));
        if (this.chart.is3d()) {
            var a = this.chart.options.plotOptions.column.grouping, b = this.chart.options.plotOptions.column.stacking, d = this.options.zIndex;
            if (!d && (void 0 === a || a) && b) {
                a = this.chart.retrieveStacks();
                b = this.options.stack || 0;
                for (d = 0; a[b].series.length > d; d++) if (a[b].series[d] === this) break;
                d = 10 * a.totalStacks - 10 * (a.totalStacks - a[b].position) - d;
    ...
    c.wrap(c.seriesTypes.pie.prototype, "animate", function(e) {
        if (this.chart.is3d()) {
            var a = arguments[1], b = this.options.animation, d = this.center, f = this.group, g = this.markerGroup;
            c.svg && (b === !0 && (b = {}), a ? (this.oldtranslateX = f.translateX, this.oldtranslateY = f.translateY, 
            a = {
                translateX: d[0],
                translateY: d[1],
                scaleX: .001,
                scaleY: .001
            }, f.attr(a), g) && (g.attrSetters = f.attrSetters, g.attr(a)) : (a = {
    ...
    c.wrap(c.seriesTypes.scatter.prototype, "init", function(c) {
        var a = c.apply(this, [].slice.call(arguments, 1));
        this.chart.is3d() && (this.pointArrayMap = [ "x", "y", "z" ], this.tooltipOptions.pointFormat = this.userOptions.tooltip ? this.userOptions.tooltip.pointFormat || "x: <b>{point.x}</b><br/>y: <b>{point.y}</b><br/>z: <b>{point.z}</b><br/>" : "x: <b>{point.x}</b><br/>y: <b>{point.y}</b><br/>z: <b>{point.z}</b><br/>");
        return a;
    });
    c.VMLRenderer && (c.setOptions({
        animate: !1
    }), c.VMLRenderer.prototype.cuboid = c.SVGRenderer.prototype.cuboid, c.VMLRenderer.prototype.cuboidPath = c.SVGRenderer.prototype.cuboidPath, 
    c.VMLRenderer.prototype.toLinePath = c.SVGRenderer.prototype.toLinePath, c.VMLRenderer.prototype.createElement3D = c.SVGRenderer.prototype.createElement3D, 
    c.VMLRenderer.prototype.arc3d = function(e) {
        ...
        for (var c, a = this.series.length; a--; ) c = this.series[a], c.translate(), c.setTooltipPoints && c.setTooltipPoints(), 
        c.render();
    }, c.wrap(c.Axis.prototype, "render", function(c) {
        c.apply(this, [].slice.call(arguments, 1));
