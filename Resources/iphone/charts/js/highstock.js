(function() {
    ...
    function W(a, b, c) {
        var d, e;
        if (Oa(b)) t(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b)); else if (t(b) && fa(b)) for (d in b) a.setAttribute(d, b[d]);
        return e;
    }
    function ma(a) {
        return Pa(a) ? a : [ a ];
    ...
    function E(a, b) {
        Ha && !ca && b && b.opacity !== r && (b.filter = "alpha(opacity=" + 100 * b.opacity + ")");
        v(a.style, b);
    }
    function $(a, b, c, d, e) {
        a = B.createElement(a);
    ...
    function Ia(a, b, c, d) {
        var e = F.lang, a = +a || 0, f = -1 === b ? (a.toString().split(".")[1] || "").length : isNaN(b = M(b)) ? 2 : b, b = void 0 === c ? e.decimalPoint : c, d = void 0 === d ? e.thousandsSep : d, e = 0 > a ? "-" : "", c = String(I(a = M(a).toFixed(f))), g = c.length > 3 ? c.length % 3 : 0;
    ...
    function Ja(a, b) {
        for (var e, f, g, h, i, c = "{", d = !1, k = []; -1 !== (c = a.indexOf(c)); ) {
            e = a.slice(0, c);
            if (d) {
                f = e.split(":");
                g = f.shift().split(".");
                ...
                f.length && (f = f.join(":"), g = /\.([0-9])/, h = F.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, 
                null !== e && (e = Ia(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : ""))) : e = ua(f, e));
            }
            k.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}" : "{";
    ...
    function Mb() {
        ...
        La = 6e4 * (a && F.global.timezoneOffset || 0);
    ...
    var r, Wa, ab, hb, F, ua, Ca, Bb, H, ib, La, ub, vb, wb, Ua, jb, kb, Nb, Ob, xb, Pb, Qb, B = document, X = window, V = Math, s = V.round, S = V.floor, Va = V.ceil, w = V.max, z = V.min, M = V.abs, da = V.cos, ia = V.sin, ra = V.PI, Ma = 2 * ra / 360, Da = navigator.userAgent, Sb = X.opera, Ha = /msie/i.test(Da) && !Sb, lb = 8 === B.documentMode, mb = /AppleWebKit/.test(Da), $a = /Firefox/.test(Da), cb = /(Mobile|Android|Windows Phone)/.test(Da), Ea = "http://www.w3.org/2000/svg", ca = !!B.createElementNS && !!B.createElementNS(Ea, "svg").createSVGRect, Yb = $a && 4 > parseInt(Da.split("Firefox/")[1], 10), ja = !ca && !Ha && !!B.createElement("canvas").getContext, Tb = {}, Ab = 0, na = function() {}, aa = [], db = 0, Ta = "div", Y = "none", Zb = /^[0-9]+$/, $b = "stroke-width", C = {}, P = X.Highcharts = X.Highcharts ? qa(16, !0) : {};
    ua = function(a, b, c) {
        if (!t(b) || isNaN(b)) return "Invalid date";
        var e, a = o(a, "%Y-%m-%d %H:%M:%S"), d = new Date(b - La), f = d[vb](), g = d[wb](), h = d[Ua](), i = d[jb](), k = d[kb](), j = F.lang, l = j.weekdays, d = v({
            a: l[g].substr(0, 3),
            A: l[g],
            d: Qa(h),
            e: h,
    ...
    Bb = {
        init: function(a, b, c) {
            var g, h, i, b = b || "", d = a.shift, e = b.indexOf("C") > -1, f = e ? 7 : 3, b = b.split(" "), c = [].concat(c), k = function(a) {
    ...
    (function(a) {
        X.HighchartsAdapter = X.HighchartsAdapter || a && {
            init: function(b) {
                ...
                a.each([ "cur", "_default", "width", "height", "opacity" ], function(a, b) {
                    ...
                    (j = e[b]) && (e[b] = function(c) {
                        var d, c = a ? c : this;
                        if ("align" !== c.prop) return d = c.elem, d.attr ? d.attr(c.prop, "cur" === b ? r : c.now) : j.apply(this, arguments);
                    });
                });
                ...
                a.fn.highcharts = function() {
                    ...
                    if (this[0]) {
                        ...
                        c = b[0];
                        c !== r && (c.chart = c.chart || {}, c.chart.renderTo = this[0], new P[a](c, b[1]), 
                        d = this);
            ...
            washMouseEvent: function(a) {
                ...
                c.pageX === r && (c.pageX = a.pageX, c.pageY = a.pageY);
                return c;
            },
        ...
        plotOptions: {
            line: {
                ...
                dataLabels: y(Q, {
                    ...
                    enabled: !1,
                    formatter: function() {
                        return null === this.y ? "" : Ia(this.y, -1);
                    },
        ...
        return {
            ...
            brighten: function(a) {
                if (d) q(d, function(b) {
                    ...
                    var c;
                    for (c = 0; 3 > c; c++) b[c] += I(255 * a), 0 > b[c] && (b[c] = 0), b[c] > 255 && (b[c] = 255);
                }
                return this;
            },
            rgba: b,
    ...
    Z.prototype = {
        init: function(a, b) {
            this.element = "span" === b ? $(b) : B.createElementNS(Ea, b);
            this.renderer = a;
        },
        opacity: 1,
        ...
        colorGradient: function(a, b, c) {
            var e, f, g, h, i, k, j, l, m, n, d = this.renderer, p = [];
            ...
            if (f) {
                ...
                "radialGradient" === f && m && !t(g.gradientUnits) && (g = y(g, {
                    cx: m[0] - m[2] / 2 + g.cx * m[2],
                    cy: m[1] - m[2] / 2 + g.cy * m[2],
                    r: g.r * m[2],
                    gradientUnits: "userSpaceOnUse"
                }));
                for (n in g) "id" !== n && p.push(n, g[n]);
                for (n in k) p.push(k[n]);
                p = p.join(",");
                h[p] ? a = h[p].attr("id") : (g.id = a = "highcharts-" + Ab++, h[p] = i = d.createElement(f).attr(g).add(d.defs), 
                i.stops = [], q(k, function(a) {
                    0 === a[1].indexOf("rgba") ? (e = Fa(a[1]), j = e.get("rgb"), l = e.get("a")) : (j = a[1], 
                    l = 1);
        ...
        attr: function(a, b) {
            ...
            "string" == typeof a && b !== r && (c = a, a = {}, a[c] = b);
        ...
        on: function(a, b) {
            ...
            ab && "click" === a ? (d.ontouchstart = function(a) {
                ...
                (-1 === Da.indexOf("Android") || Date.now() - (c.touchEventFired || 0) > 1100) && b.call(d, a);
            }) : d["on" + a] = b;
            return this;
        },
        ...
        align: function(a, b, c) {
            ...
            e = this.renderer;
            f = e.alignedObjects;
            a ? (this.alignOptions = a, this.alignByTranslate = b, !c || Oa(c)) && (this.alignTo = d = c || "renderer", 
            pa(f, this), f.push(this), c = null) : (a = this.alignOptions, b = this.alignByTranslate, 
            d = this.alignTo);
            c = o(c, e[d], e);
            d = a.align;
            e = a.verticalAlign;
        ...
        getBBox: function() {
            ...
            d = this.textStr;
            var h;
            ("" === d || Zb.test(d)) && (h = "num." + d.toString().length + (f ? "|" + f.fontSize + "|" + f.fontFamily : ""));
            h && (a = b.cache[h]);
            if (!a) {
                ...
                if (b.isSVG) {
                    c = a.width;
                    d = a.height;
                    Ha && f && "11px" === f.fontSize && "16.9" === d.toPrecision(3) && (a.height = d = 14);
                    e && (a.width = M(d * ia(g)) + M(c * da(g)), a.height = M(d * da(g)) + M(c * ia(g)));
                }
                this.bBox = a;
                h && (b.cache[h] = a);
            }
        ...
        show: function(a) {
            return a && this.element.namespaceURI === Ea ? (this.element.removeAttribute("visibility"), 
            this) : this.attr({
        ...
        add: function(a) {
            ...
            if (c.handleZ) {
                a = d.childNodes;
                for (g = 0; a.length > g; g++) if (b = a[g], c = W(b, "zIndex"), b !== e && (I(c) > f || !t(f) && t(c))) {
                    d.insertBefore(e, b);
                    h = !0;
                    break;
                }
        ...
        shadow: function(a, b, c) {
            var e, f, h, i, k, j, d = [], g = this.element;
            if (a) {
                i = o(a.width, 3);
                k = (a.opacity || .15) / i;
                ...
                for (e = 1; i >= e; e++) {
                    ...
                    c && (W(f, "height", w(W(f, "height") - h, 0)), f.cutHeight = h);
    ...
    ka.prototype = {
        ...
        init: function(a, b, c, d, e) {
            ...
            g = d.element;
            a.appendChild(g);
            -1 === a.innerHTML.indexOf("xmlns") && W(g, "xmlns", Ea);
            this.isSVG = !0;
            this.box = g;
            this.boxWrapper = d;
            this.alignedObjects = [];
        ...
        buildText: function(a) {
            for (var h, i, b = a.element, c = this, d = c.forExport, e = o(a.textStr, "").toString(), f = -1 !== e.indexOf("<"), g = b.childNodes, k = W(b, "x"), j = a.styles, l = a.textWidth, m = j && j.lineHeight, n = g.length, p = function(a) {
            ...
            "" === e[e.length - 1] && e.pop(), q(e, function(e, f) {
                ...
                q(g, function(e) {
                    if ("" !== e || 1 === g.length) {
                        var o, n = {}, u = B.createElementNS(Ea, "tspan");
                        ...
                        if (" " !== e) {
                            ...
                            b.appendChild(u);
                            m++;
                            if (l) for (var q, r, e = e.replace(/([^\^])-/g, "$1- ").split(" "), n = e.length > 1 && "nowrap" !== j.whiteSpace, D = a._clipHeight, t = [], s = p(), w = 1; n && (e.length || t.length); ) delete a.bBox, 
                            q = a.getBBox(), r = q.width, !ca && c.forExport && (r = c.measureSpanWidth(u.firstChild.data, a.styles)), 
                            q = r > l, q && 1 !== e.length ? (u.removeChild(u.firstChild), t.unshift(e.pop())) : (e = t, 
                            t = [], e.length && (w++, D && w * s > D ? (e = [ "..." ], a.attr("title", a.textStr)) : (u = B.createElementNS(Ea, "tspan"), 
                            W(u, {
                                dy: s,
                                x: k
                            }), o && W(u, "style", o), b.appendChild(u), r > l && (l = r)))), e.length && u.appendChild(B.createTextNode(e.join(" ").replace(/- /g, "-")));
                        }
                    }
                });
        ...
        button: function(a, b, c, d, e, f, g, h, i) {
            var l, m, n, p, u, o, k = this.label(a, b, c, i, null, null, null, null, "button"), j = 0, a = {
                x1: 0,
                y1: 0,
                x2: 0,
                y2: 1
            ...
            A(k.element, Ha ? "mouseout" : "mouseleave", function() {
                3 !== j && (l = [ e, f, g ][j], m = [ n, p, u ][j], k.attr(l).css(m));
            });
            k.setState = function(a) {
                (k.state = j = a) ? 2 === a ? k.attr(g).css(u) : 3 === a && k.attr(h).css(o) : k.attr(e).css(n);
            };
        ...
        arc: function(a, b, c, d, e, f) {
            fa(a) && (b = a.y, c = a.r, d = a.innerR, e = a.start, f = a.end, a = a.x);
        ...
        rect: function(a, b, c, d, e, f) {
            ...
            f !== r && (a.strokeWidth = f, a = g.crisp(a));
            e && (a.r = e);
        ...
        symbol: function(a, b, c, d, e, f) {
            var g, k, j, h = this.symbols[a], h = h && h(s(b), s(c), d, e, f), i = /^url\((.*?)\)$/;
            h ? (g = this.path(h), v(g, {
                symbolName: a,
                x: b,
                y: c,
                width: d,
                height: e
            }), f && v(g, f)) : i.test(a) && (j = function(a, b) {
                a.element && (a.attr({
                    width: b[0],
                    height: b[1]
        ...
        symbols: {
            ...
            arc: function(a, b, c, d, e) {
                var f = e.start, c = e.r || c || d, g = e.end - .001, d = e.innerR, h = e.open, i = da(f), k = ia(f), j = da(g), g = ia(g), e = ra > e.end - f ? 0 : 1;
        ...
        text: function(a, b, c, d) {
            ...
            d || (a.xSetter = function(a, b, c) {
                ...
                for (f = 1; d.length > f; f++) e = d[f], e.getAttribute("x") === c.getAttribute("x") && e.setAttribute("x", a);
                c.setAttribute(b, a);
            });
            return a;
        },
        fontMetrics: function(a) {
            var a = a || this.style.fontSize, a = /px/.test(a) ? I(a) : /em/.test(a) ? 12 * parseFloat(a) : 12, a = 24 > a ? a + 4 : s(1.2 * a), b = s(.8 * a);
            return {
                h: a,
                b: b
            };
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            function k() {
                var a, b;
                a = p.element.style;
                o = (void 0 === bb || void 0 === Eb || n.styles.textAlign) && p.textStr && p.getBBox();
                n.width = (bb || o.width || 0) + 2 * x + w;
                n.height = (Eb || o.height || 0) + 2 * x;
                U = x + m.fontMetrics(a && a.fontSize).b;
                if (z) {
                    u || (a = s(-G * x), b = h ? -U : 0, n.box = u = d ? m.symbol(d, a, b, n.width, n.height, D) : m.rect(a, b, n.width, n.height, 0, D[$b]), 
                    u.attr("fill", Y).add(n));
                    u.isImg || u.attr(v({
                        width: s(n.width),
                        height: s(n.height)
            ...
            function j() {
                var c, a = n.styles, a = a && a.textAlign, b = w + x * (1 - G);
                c = h ? 0 : U;
                t(bb) && o && ("center" === a || "right" === a) && (b += {
                    center: .5,
                    right: 1
                }[a] * (bb - o.width));
                (b !== p.x || c !== p.y) && (p.attr("x", b), c !== r && p.attr("y", c));
                p.x = b;
                p.y = c;
            }
            function l(a, b) {
            ...
            var u, o, bb, Eb, Fb, Gb, U, z, m = this, n = m.g(i), p = m.text("", 0, 0, g).attr({
                zIndex: 1
            }), G = 0, x = 3, w = 0, Ub = 0, D = {};
            n.onAdd = function() {
                p.add(n);
    ...
    v(Z.prototype, {
        ...
        htmlUpdateTransform: function() {
            if (this.added) {
                ...
                if ("SPAN" === b.tagName) {
                    var j, k = this.rotation, l = I(this.textWidth), m = [ k, g, b.innerHTML, this.textWidth ].join(",");
                    if (m !== this.cTT) {
                        j = a.fontMetrics(b.style.fontSize).b;
                        t(k) && this.setSpanRotation(k, h, j);
                        i = o(this.elemWidth, b.offsetWidth);
                        i > l && /[ \-]/.test(b.textContent || b.innerText) && (E(b, {
                            width: l + "px",
                            display: "block",
                            whiteSpace: "normal"
                        }), i = l);
    ...
    ca || ja || (P.VMLElement = ea = {
        ...
        getSpanCorrection: function(a, b, c, d, e) {
            var i, f = d ? da(d * Ma) : 1, g = d ? ia(d * Ma) : 0, h = o(this.elemHeight, this.element.offsetHeight);
            this.xCorr = 0 > f && -a;
            this.yCorr = 0 > g && -h;
            i = 0 > f * g;
        ...
        pathToVML: function(a) {
            for (var b = a.length, c = []; b--; ) la(a[b]) ? c[b] = s(10 * a[b]) - 5 : "Z" === a[b] ? c[b] = "x" : (c[b] = a[b], 
        ...
        cutOffPath: function(a, b) {
            var c, a = a.split(/[ ,]/);
            c = a.length;
            (9 === c || 11 === c) && (a[c - 4] = a[c - 2] = I(a[c - 2]) - 10 * b);
            return a.join(" ");
        },
        shadow: function(a, b, c) {
            var e, h, k, l, m, n, p, d = [], f = this.element, g = this.renderer, i = f.style, j = f.path;
            ...
            if (a) {
                ...
                for (e = 1; 3 >= e; e++) {
                    l = 2 * n + 1 - 2 * e;
                    c && (m = this.cutOffPath(j.value, l + .5));
        ...
        fillSetter: function(a, b, c) {
            var d = c.nodeName;
            "SPAN" === d ? c.style.color = a : "IMG" !== d && (c.filled = a !== Y, this.setAttr("fillcolor", this.renderer.color(a, c, b, this)));
        },
        opacitySetter: na,
        ...
        visibilitySetter: function(a, b, c) {
            ...
            "DIV" === c.nodeName && (a = "hidden" === a ? "-999em" : 0, lb || (c.style[b] = a ? "visible" : "hidden"), 
            b = "top");
            c.style[b] = a;
        },
    ...
    }, ea = ga(Z, ea), ea.prototype.ySetter = ea.prototype.widthSetter = ea.prototype.heightSetter = ea.prototype.xSetter, 
    ea = {
        Element: ea,
        ...
        color: function(a, b, c, d) {
            var f, h, i, e = this, g = /^rgba/, k = Y;
            a && a.linearGradient ? i = "gradient" : a && a.radialGradient && (i = "pattern");
            if (i) {
                var j, l, n, p, u, o, G, r, m = a.linearGradient || a.radialGradient, x = "", a = a.stops, t = [], s = function() {
                ...
                n = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, x = 'angle="' + (90 - 180 * V.atan((m - a) / (n - c)) / ra) + '"', 
                s(); else {
                    var z, k = m.r, w = 2 * k, v = 2 * k, y = m.cx, D = m.cy, U = b.radialReference, k = function() {
                        U && (z = d.getBBox(), y += (U[0] - z.x) / z.width - .5, D += (U[1] - z.y) / z.height - .5, 
                        w *= U[2] / z.width, v *= U[2] / z.height);
            ...
            } else if (g.test(a) && "IMG" !== b.tagName) f = Fa(a), h = [ "<", c, ' opacity="', f.get("a"), '"/>' ], 
            $(this.prepVML(h), null, null, b), k = f.get("rgb"); else {
        ...
        createElement: function(a) {
            return "rect" === a ? this.symbol(a) : ka.prototype.createElement.call(this, a);
        },
        ...
        symbols: {
            arc: function(a, b, c, d, e) {
                var f = e.start, g = e.end, h = e.r || c || d, c = e.innerR, d = da(f), i = ia(f), k = da(g), j = ia(g);
                if (0 === g - f) return [ "x" ];
            ...
            rect: function(a, b, c, d, e) {
                return ka.prototype.symbols[t(e) && e.r ? "callout" : "square"].call(0, a, b, c, d, e);
            }
        }
    ...
    var Vb;
    ja && (P.CanVGRenderer = ea = function() {
    ...
    Za.prototype = {
        addLabel: function() {
            var l, a = this.axis, b = a.options, c = a.chart, d = a.horiz, e = a.categories, f = a.names, g = this.pos, h = b.labels, i = a.tickPositions, d = d && e && !h.step && !h.staggerLines && !h.rotation && c.plotWidth / i.length || !d && (c.margin[3] || .33 * c.chartWidth), k = g === i[0], j = g === i[i.length - 1], f = e ? o(e[g], f[g], g) : g, e = this.label, m = i.info;
            ...
            if (t(e)) e && e.attr({
                ...
                la(h.rotation) && (l.rotation = h.rotation);
        ...
        handleOverflow: function(a, b) {
            var l, m, n, c = !0, d = this.axis, e = this.isFirst, f = this.isLast, g = d.horiz ? b.x : b.y, h = d.reversed, i = d.tickPositions, k = this.getLabelSides(), j = k[0], k = k[1], p = this.label.line || 0;
            l = d.labelEdge;
            ...
            if (m) {
                ...
                e && !h || f && h ? l > g + j && (g = l - j, n && g + k > d && (c = !1)) : g + k > m && (g = m - k, 
                n && d > g + j && (c = !1));
                b.x = g;
            }
            return c;
        ...
        render: function(a, b, c) {
            ...
            if (p) {
                ...
                !b && l && k && l[this.isNew ? "attr" : "animate"]({
                    d: k,
                    opacity: c
                });
            }
            m && G && ("inside" === t && (G = -G), d.opposite && (G = -G), h = this.getMarkPath(z, y, G, m * D, g, f), 
            n ? n.animate({
                d: h,
                opacity: c
            ...
            i && !isNaN(z) && (i.xy = y = this.getLabelPosition(z, y, i, g, j, v, a, s), this.isFirst && !this.isLast && !o(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !o(e.showLastLabel, 1) ? w = !1 : !d.isRadial && !j.step && !j.rotation && !b && 0 !== c && (w = this.handleOverflow(a, y)), 
            s && a % s && (w = !1), w && !isNaN(y.y) ? (y.opacity = c, i[this.isNew ? "attr" : "animate"](y), 
    ...
    P.PlotLineOrBand.prototype = {
        render: function() {
            var u, a = this, b = a.axis, c = b.horiz, d = (b.pointRange || 0) / 2, e = a.options, f = e.label, g = a.label, h = e.width, i = e.to, k = e.from, j = t(k) && t(i), l = e.value, m = e.dashStyle, n = a.svgElem, p = [], q = e.color, G = e.zIndex, x = e.events, r = {}, s = b.chart.renderer;
            b.isLog && (k = Ga(k), i = Ga(i), l = Ga(l));
            if (h) (p = b.getPlotLinePath(l, h), r = {
                stroke: q,
                "stroke-width": h
            }, m) && (r.dashstyle = m); else {
                if (!j) return;
                k = w(k, b.min - d);
                i = z(i, b.max + d);
            ...
            if (n) p ? n.animate({
                ...
                n.show();
            }, g) && (a.label = g = g.destroy()); else if (p && p.length && (a.svgElem = n = s.path(p).attr(r).add(), 
            x)) for (u in d = function(b) {
                n.on(b, function(c) {
                    x[b].apply(a, [ c ]);
                });
            }, x) d(u);
    ...
    L.prototype = {
        ...
        init: function(a, b) {
            ...
            -1 === wa(this, a.axes) && (c && !this.isColorAxis ? a.axes.splice(a.xAxis.length, 0, this) : a.axes.push(this), 
            a[this.coll].push(this));
            this.series = this.series || [];
            a.inverted && c && this.reversed === r && (this.reversed = !0);
            this.removePlotLine = this.removePlotBand = this.removePlotBandOrLine;
            for (f in d) A(this, f, d[f]);
            this.isLog && (this.val2lin = Ga, this.lin2val = oa);
        },
        ...
        defaultLabelFormatter: function() {
            var g, a = this.axis, b = this.value, c = a.categories, d = this.dateTimeLabelFormat, e = F.lang.numericSymbols, f = e && e.length, h = a.options.labels.format, a = a.isLog ? b : a.tickInterval;
            if (h) g = Ja(h, this); else if (c) g = b; else if (d) g = ua(d, b); else if (f && a >= 1e3) for (;f-- && g === r; ) c = Math.pow(1e3, f + 1), 
            a >= c && null !== e[f] && (g = Ia(b / c, -1) + e[f]);
        ...
        getSeriesExtremes: function() {
            ...
            q(a.series, function(c) {
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    a.isLog && 0 >= d && (d = null);
                    if (a.isXAxis) (d = c.xData, d.length) && (a.dataMin = z(o(a.dataMin, d[0]), Ra(d)), 
                    a.dataMax = w(o(a.dataMax, d[0]), Ba(d))); else {
                        c.getExtremes();
                        e = c.dataMax;
                        c = c.dataMin;
                        t(c) && t(e) && (a.dataMin = z(o(a.dataMin, c), c), a.dataMax = w(o(a.dataMax, e), e));
                        t(d) && (a.dataMin >= d ? (a.dataMin = d, a.ignoreMinPadding = !0) : d > a.dataMax && (a.dataMax = d, 
        ...
        translate: function(a, b, c, d, e, f) {
            ...
            b ? (a = a * g + h, a -= k, a = a / i + d, e && (a = this.lin2val(a))) : (e && (a = this.val2lin(a)), 
            "between" === f && (f = .5), a = g * (a - d) * i + h + g * k + (la(f) ? i * f * this.pointRange : 0));
            return a;
        },
        ...
        getPlotLinePath: function(a, b, c, d, e) {
            var i, k, m, f = this.chart, g = this.left, h = this.top, j = c && f.oldChartHeight || f.chartHeight, l = c && f.oldChartWidth || f.chartWidth;
            i = this.transB;
            e = o(e, this.translate(a, null, null, c));
            a = c = s(e + i);
            i = k = s(j - e - i);
            isNaN(e) ? m = !0 : this.horiz ? (i = h, k = j - this.bottom, g > a || a > g + this.width) && (m = !0) : (a = g, 
        ...
        adjustForMinRange: function() {
            var d, f, g, h, i, k, a = this.options, b = this.min, c = this.max, e = this.dataMax - this.dataMin >= this.minRange;
            this.isXAxis && this.minRange === r && !this.isLog && (t(a.min) || t(a.max) ? this.minRange = null : (q(this.series, function(a) {
                i = a.xData;
                for (g = k = a.xIncrement ? 1 : i.length - 1; g > 0; g--) (h = i[g] - i[g - 1], 
                f === r || f > h) && (f = h);
            ...
            if (this.minRange > c - b) {
                ...
                e && (c[2] = this.dataMax);
                c = Ra(c);
                j > c - b && (d[0] = c - j, d[1] = o(a.min, c - j), b = Ba(d));
            }
            this.min = b;
            this.max = c;
        },
        setAxisTranslation: function(a) {
            var e, b = this, c = b.max - b.min, d = b.axisPointRange || 0, f = 0, g = 0, h = b.linkedParent, i = !!b.categories, k = b.transA;
            ...
            b.pointRangePadding = g *= h, b.pointRange = z(d, c), b.closestPointRange = e);
            a && (b.oldTransA = k);
        ...
        setTickPositions: function(a) {
            var p, b = this, c = b.chart, d = b.options, e = b.isLog, f = b.isDatetimeAxis, g = b.isXAxis, h = b.isLinked, i = b.options.tickPositioner, k = d.maxPadding, j = d.minPadding, l = d.tickInterval, m = d.minTickInterval, n = d.tickPixelInterval, u = b.categories;
            h ? (b.linkedParent = c[b.coll][d.linkedTo], c = b.linkedParent.getExtremes(), b.min = o(c.min, c.dataMin), 
            b.max = o(c.max, c.dataMax), d.type !== b.linkedParent.options.type && qa(11, 1)) : (b.min = o(b.userMin, d.min, b.dataMin), 
            b.max = o(b.userMax, d.max, b.dataMax));
            e && (!a && 0 >= z(b.min, o(b.dataMin, b.min)) && qa(10, 1), b.min = ha(Ga(b.min)), 
            b.max = ha(Ga(b.max)));
            b.range && t(b.max) && (b.userMin = b.min = w(b.min, b.max - b.range), b.userMax = b.max, 
            b.range = null);
            b.beforePadding && b.beforePadding();
            b.adjustForMinRange();
            if (!u && !b.axisPointRange && !b.usePercentage && !h && t(b.min) && t(b.max) && (c = b.max - b.min)) {
                t(d.min) || t(b.userMin) || !j || !(0 > b.dataMin) && b.ignoreMinPadding || (b.min -= c * j);
                t(d.max) || t(b.userMax) || !k || !(b.dataMax > 0) && b.ignoreMaxPadding || (b.max += c * k);
            }
            la(d.floor) && (b.min = w(b.min, d.floor));
            la(d.ceiling) && (b.max = z(b.max, d.ceiling));
            b.min === b.max || void 0 === b.min || void 0 === b.max ? b.tickInterval = 1 : h && !l && n === b.linkedParent.options.tickPixelInterval ? b.tickInterval = b.linkedParent.tickInterval : (b.tickInterval = o(l, u ? 1 : (b.max - b.min) * n / w(b.len, n)), 
            !t(l) && n > b.len && !this.isRadial && !this.isLog && !u && d.startOnTick && d.endOnTick && (p = !0, 
            b.tickInterval /= 4));
            ...
            f || e || l || (b.tickInterval = sb(b.tickInterval, null, rb(b.tickInterval), d));
            ...
            a || (!b.ordinalPositions && (b.max - b.min) / b.tickInterval > w(2 * b.len, 200) && qa(19, !0), 
            ...
            p && a.splice(1, a.length - 2), b.tickPositions = a);
            h || (e = a[0], f = a[a.length - 1], h = b.minPointOffset || 0, d.startOnTick ? b.min = e : b.min - h > e && a.shift(), 
            d.endOnTick ? b.max = f : f > b.max + h && a.pop(), 1 === a.length && (d = M(b.max) > 1e13 ? 1 : .001, 
            b.min -= d, b.max += d));
        },
        ...
        adjustTickAmount: function() {
            ...
            if (c && c[a] && !this.isDatetimeAxis && !this.categories && !this.isLinked && this.options.alignTicks !== !1 && this.min !== r) {
                ...
                if (a > e) {
                    for (;a > b.length; ) b.push(ha(b[b.length - 1] + this.tickInterval));
                    this.transA *= (e - 1) / (a - 1);
        ...
        zoom: function(a, b) {
            ...
            this.allowZoomOutside || (t(c) && z(c, o(e.min, c)) >= a && (a = r), t(d) && b >= w(d, o(e.max, d)) && (b = r));
        ...
        getOffset: function() {
            var k, l, s, z, A, B, D, a = this, b = a.chart, c = b.renderer, d = a.options, e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side, i = b.inverted ? [ 1, 0, 3, 2 ][h] : h, j = 0, m = 0, n = d.title, p = d.labels, u = 0, Db = b.axisOffset, G = b.clipOffset, x = [ -1, 1, 1, -1 ][h], v = 1, y = o(p.maxStaggerLines, 5), U = 2 === h ? c.fontMetrics(p.style.fontSize).b : 0;
            ...
            if (k || a.isLinked) {
                ...
                if (a.horiz && !a.staggerLines && y && !p.rotation) {
                    for (s = a.reversed ? [].concat(e).reverse() : e; y > v; ) {
                        k = [];
                        z = !1;
                        for (p = 0; s.length > p; p++) A = s[p], B = (B = f[A].label && f[A].label.getBBox()) ? B.width : 0, 
                        D = p % v, B && (A = a.translate(A), k[D] !== r && k[D] > A && (z = !0), k[D] = A + B);
                        if (!z) break;
                        v++;
                    }
            ...
            if (n && n.text && n.enabled !== !1) {
                ...
                a.axisTitle.isNew = !0);
                b && (j = a.axisTitle.getBBox()[g ? "height" : "width"], m = o(n.margin, g ? 5 : 10), 
                l = n.offset);
        ...
        render: function() {
            var k, v, A, a = this, b = a.horiz, c = a.reversed, d = a.chart, e = d.renderer, f = a.options, g = a.isLog, h = a.isLinked, i = a.tickPositions, j = a.axisTitle, l = a.ticks, m = a.minorTicks, n = a.alternateBands, p = f.stackLabels, u = f.alternateGridColor, o = a.tickmarkOffset, G = f.lineWidth, x = d.hasRendered && t(a.oldMin) && !isNaN(a.oldMin), s = a.hasData, w = a.showAxis, y = f.labels.overflow, z = a.justifyLabels = b && y !== !1;
            a.labelEdge.length = 0;
            a.justifyToPlot = "justify" === y;
            q([ l, m, n ], function(a) {
                for (var b in a) a[b].isActive = !1;
            });
            (s || h) && ((a.minorTickInterval && !a.categories && q(a.getMinorTickPositions(), function(b) {
                m[b] || (m[b] = new Za(a, b, "minor"));
                x && m[b].isNew && m[b].render(null, !0);
                m[b].render(null, !1, 1);
            }), i.length && (k = i.slice(), (b && c || !b && !c) && k.reverse(), z && (k = k.slice(1).concat([ k[0] ])), 
            q(k, function(b, c) {
                z && (c = c === k.length - 1 ? 0 : c + 1);
                (!h || b >= a.min && a.max >= b) && (l[b] || (l[b] = new Za(a, b)), x && l[b].isNew && l[b].render(c, !0, .1), 
                l[b].render(c, !1, 1));
            }), o && 0 === a.min && (l[-1] || (l[-1] = new Za(a, -1, null, !0)), l[-1].render(-1))), 
            u && q(i, function(b, c) {
                0 === c % 2 && a.max > b && (n[b] || (n[b] = new P.PlotLineOrBand(a)), v = b + o, 
                A = i[c + 1] !== r ? i[c + 1] + o : a.max, n[b].options = {
                    from: g ? oa(v) : v,
                    to: g ? oa(A) : A,
                    color: u
            ...
            G && (b = a.getLinePath(G), a.axisLine ? a.axisLine.animate({
                d: b
            ...
            j && w && (j[j.isNew ? "attr" : "animate"](a.getTitlePosition()), j.isNew = !1);
    ...
    L.prototype.getTimeTicks = function(a, b, c, d) {
        var h, e = [], f = {}, g = F.global.useUTC, i = new Date(b - La), k = a.unitRange, j = a.count;
        if (t(b)) {
            k >= H.second && (i.setMilliseconds(0), i.setSeconds(k >= H.minute ? 0 : j * S(i.getSeconds() / j)));
            k >= H.minute && i[Nb](k >= H.hour ? 0 : j * S(i[ub]() / j));
            k >= H.hour && i[Ob](k >= H.day ? 0 : j * S(i[vb]() / j));
            k >= H.day && i[xb](k >= H.month ? 1 : j * S(i[Ua]() / j));
            k >= H.month && (i[Pb](k >= H.year ? 0 : j * S(i[jb]() / j)), h = i[kb]());
            k >= H.year && (h -= h % j, i[Qb](h));
            k === H.week && i[xb](i[Ua]() - i[wb]() + o(d, 1));
            b = 1;
            La && (i = new Date(i.getTime() + La));
            h = i[kb]();
            for (var d = i.getTime(), l = i[jb](), m = i[Ua](), n = g ? La : (864e5 + 6e4 * i.getTimezoneOffset()) % 864e5; c > d; ) e.push(d), 
            k === H.year ? d = ib(h + b * j, 0) : k === H.month ? d = ib(h, l + b * j) : g || k !== H.day && k !== H.week ? d += k * j : d = ib(h, l, m + b * j * (k === H.day ? 1 : 7)), 
            b++;
            e.push(d);
            q(Cb(e, function(a) {
                return H.hour >= k && a % H.day === n;
            }), function(a) {
                f[a] = "day";
            });
        }
    ...
    L.prototype.normalizeTimeTickInterval = function(a, b) {
        ...
        for (g = 0; c.length > g; g++) if (d = c[g], e = H[d[0]], f = d[1], c[g + 1] && (e * f[f.length - 1] + H[c[g + 1][0]]) / 2 >= a) break;
        e === H.year && 5 * e > a && (f = [ 1, 2, 5 ]);
        c = sb(a / e, f, "year" === d[0] ? w(rb(a / e), 1) : 1);
        return {
            unitRange: e,
            count: c,
            unitName: d[0]
    ...
    L.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        if (a >= .5) a = s(a), g = this.getLinearTickPositions(a, b, c); else if (a >= .08) for (var h, i, k, j, l, f = S(b), e = a > .3 ? [ 1, 2, 4 ] : a > .15 ? [ 1, 2, 4, 6, 8 ] : [ 1, 2, 3, 4, 5, 6, 7, 8, 9 ]; c + 1 > f && !l; f++) {
            i = e.length;
            for (h = 0; i > h && !l; h++) k = Ga(oa(f) * e[h]), k > b && (!d || c >= j) && g.push(j), 
            j > c && (l = !0), j = k;
        } else (b = oa(b), c = oa(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = o("auto" === a ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), 
        a = sb(a, null, rb(a)), g = xa(this.getLinearTickPositions(a, b, c), Ga), d) || (this._minorAutoInterval = a / 5);
    ...
    Hb.prototype = {
        ...
        getAnchor: function(a, b) {
            var c, i, d = this.chart, e = d.inverted, f = d.plotTop, g = 0, h = 0, a = ma(a);
            c = a[0].tooltipPos;
        ...
        getPosition: function(a, b, c) {
            var g, d = this.chart, e = this.distance, f = {}, h = [ "y", d.chartHeight, b, c.plotY + d.plotTop ], i = [ "x", d.chartWidth, a, c.plotX + d.plotLeft ], k = c.ttBelow || d.inverted && !c.negative || !d.inverted && c.negative, j = function(a, b, c, d) {
                var g = d - e > c, b = b > d + e + c, c = d - e - c;
                d += e;
                if (k && b) f[a] = d; else if (!k && g) f[a] = c; else if (g) f[a] = c; else {
                    if (!b) return !1;
                    f[a] = d;
                }
            }, l = function(a, b, c, d) {
                ...
                j.apply(0, h) !== !1 ? l.apply(0, i) === !1 && !g && (m(!0), n()) : g ? f.x = f.y = 0 : (m(!0), 
                n());
            };
        ...
        defaultFormatter: function(a) {
            var d, b = this.points || ma(this), c = b[0].series;
        ...
        refresh: function(a, b) {
            var f, g, i, c = this.chart, d = this.label, e = this.options, h = {}, k = [];
            i = e.formatter || this.defaultFormatter;
            var j, h = c.hoverPoints, l = this.shared;
            clearTimeout(this.hideTimer);
            ...
            h && q(h, function(a) {
                ...
                x: a[0].category,
                y: a[0].y
            }, h.points = k, this.len = k.length, a = a[0]);
            i = i.call(h, this);
            h = a.series;
            this.distance = o(h.tooltipOptions.distance, 16);
            i === !1 ? this.hide() : (this.isHidden && (eb(d), d.attr("opacity", 1).show()), 
            d.attr({
                text: i
        ...
        tooltipHeaderFormatter: function(a) {
            var h, b = a.series, c = b.tooltipOptions, d = c.dateTimeLabelFormats, e = c.xDateFormat, f = b.xAxis, g = f && "datetime" === f.options.type && la(a.key), c = c.headerFormat, f = f && f.closestPointRange;
            if (g && !e) {
                if (f) {
                    for (h in H) if (H[h] >= f || H[h] <= H.day && a.key % H[h] > 0) {
                        e = d[h];
                        break;
                    }
                } else e = d.day;
    ...
    Xa.prototype = {
        init: function(a, b) {
            var f, c = b.chart, d = c.events, e = ja ? "" : c.zoomType, c = a.inverted;
            this.options = b;
            this.chart = a;
            ...
            this.pinchDown = [];
            this.lastValidTouch = {};
            P.Tooltip && b.tooltip.enabled && (a.tooltip = new Hb(a, b.tooltip), this.followTouchMove = b.tooltip.followTouchMove);
            this.setDOMEvents();
        },
        normalize: function(a, b) {
            ...
            b || (this.chartPosition = b = bc(this.chart.container));
            d.pageX === r ? (c = w(a.x, a.clientX - b.left), d = a.y) : (c = d.pageX - b.left, 
            d = d.pageY - b.top);
            return v(a, {
                chartX: s(c),
                chartY: s(d)
        ...
        runPointActions: function(a) {
            var e, f, i, k, b = this.chart, c = b.series, d = b.tooltip, g = b.hoverPoint, h = b.hoverSeries, j = b.chartWidth, l = this.getIndex(a);
            if (d && this.options.tooltip.shared && (!h || !h.noSharedTooltip)) {
                f = [];
                i = c.length;
                for (k = 0; i > k; k++) c[k].visible && c[k].options.enableMouseTracking !== !1 && !c[k].noSharedTooltip && c[k].singularTooltips !== !0 && c[k].tooltipPoints.length && (e = c[k].tooltipPoints[l]) && e.series && (e._dist = M(l - e.clientX), 
            ...
            h && h.tracker && !c ? (e = h.tooltipPoints[l]) && e !== g && e.onMouseOver(a) : d && c && !d.isHidden && (h = d.getAnchor([ {} ], a), 
            d.updatePosition({
                plotX: h[0],
                plotY: h[1]
            }));
            d && !this._onDocumentMouseMove && (this._onDocumentMouseMove = function(a) {
                aa[sa] && aa[sa].pointer.onDocumentMouseMove(a);
        ...
        reset: function(a) {
            ...
            if (a) e.refresh(f), d && d.setState(d.state, !0); else {
                ...
                c && c.onMouseOut();
                e && e.hide();
                this._onDocumentMouseMove && (R(B, "mousemove", this._onDocumentMouseMove), this._onDocumentMouseMove = null);
                q(b.axes, function(a) {
                    a.hideCrosshair();
                });
                this.hoverX = null;
        ...
        drag: function(a) {
            var l, b = this.chart, c = b.options.chart, d = a.chartX, e = a.chartY, f = this.zoomHor, g = this.zoomVert, h = b.plotLeft, i = b.plotTop, k = b.plotWidth, j = b.plotHeight, m = this.mouseDownX, n = this.mouseDownY;
            h > d ? d = h : d > h + k && (d = h + k);
            i > e ? e = i : e > i + j && (e = i + j);
            this.hasDragged = Math.sqrt(Math.pow(m - d, 2) + Math.pow(n - e, 2));
            if (this.hasDragged > 10) {
                l = b.isInsidePlot(m - h, n - i);
                b.hasCartesianSeries && (this.zoomX || this.zoomY) && l && !this.selectionMarker && (this.selectionMarker = b.renderer.rect(h, i, f ? 1 : k, g ? 1 : j, 0).attr({
        ...
        drop: function(a) {
            ...
            if (this.selectionMarker) {
                ...
                (this.hasDragged || c) && (q(b.axes, function(a) {
                    if (a.zoomEnabled) {
        ...
        setDOMEvents: function() {
            ...
            1 === db && A(B, "mouseup", a.onDocumentMouseUp);
            ab && (b.ontouchstart = function(b) {
                a.onContainerTouchStart(b);
            }, b.ontouchmove = function(b) {
                a.onContainerTouchMove(b);
            }, 1 === db && A(B, "touchend", a.onDocumentTouchEnd));
        },
        destroy: function() {
            var a;
    ...
    v(P.Pointer.prototype, {
        ...
        pinchTranslateDirection: function(a, b, c, d, e, f, g, h) {
            var p, u, y, i = this.chart, k = a ? "x" : "y", j = a ? "X" : "Y", l = "chart" + j, m = a ? "width" : "height", n = i["plot" + (a ? "Left" : "Top")], o = h || 1, q = i.inverted, x = i.bounds[a ? "h" : "v"], r = 1 === b.length, s = b[0][l], t = c[0][l], w = !r && b[1][l], v = !r && c[1][l], c = function() {
                !r && M(s - w) > 20 && (o = h || M(t - v) / M(s - w));
                u = (n - t) / o + s;
                p = i["plot" + (a ? "Width" : "Height")] / o;
            };
            c();
            b = u;
            x.min > b ? (b = x.min, y = !0) : b + p > x.max && (b = x.max - p, y = !0);
            y ? (t -= .8 * (t - g[k][0]), r || (v -= .8 * (v - g[k][1])), c()) : g[k] = [ t, v ];
            q || (f[k] = u - n, f[m] = p);
            f = q ? 1 / o : o;
            e[m] = p;
            e[k] = b;
        ...
        pinch: function(a) {
            var b = this, c = b.chart, d = b.pinchDown, e = b.followTouchMove, f = a.touches, g = f.length, h = b.lastValidTouch, i = b.hasZoom, k = b.selectionMarker, j = {}, l = 1 === g && (b.inClass(a.target, "highcharts-tracker") && c.runTrackerClick || c.runChartClick), m = {};
            (i || e) && !l && a.preventDefault();
            xa(f, function(a) {
                return b.normalize(a);
            });
            if ("touchstart" === a.type) q(f, function(a, b) {
                d[b] = {
                    chartX: a.chartX,
                    chartY: a.chartY
                };
    ...
    if (X.PointerEvent || X.MSPointerEvent) {
        var ya = {}, Ib = !!X.PointerEvent, gc = function() {
            ...
            a = a.originalEvent || a;
            "touch" !== a.pointerType && a.pointerType !== a.MSPOINTER_TYPE_TOUCH || !aa[sa] || (d(a), 
            d = aa[sa].pointer, d[b]({
                type: c,
        ...
        v(Xa.prototype, {
            ...
            onContainerPointerMove: function(a) {
                Jb(a, "onContainerTouchMove", "touchmove", function(a) {
                    ...
                    ya[a.pointerId].target || (ya[a.pointerId].target = a.currentTarget);
                });
            },
    ...
    pb.prototype = {
        init: function(a, b) {
            ...
            this.options = b;
            b.enabled && (c.baseline = I(d.fontSize) + 3 + f, c.itemStyle = d, c.itemHiddenStyle = y(d, b.itemHiddenStyle), 
        ...
        colorizeItem: function(a, b) {
            var k, c = this.options, d = a.legendItem, e = a.legendLine, f = a.legendSymbol, g = this.itemHiddenStyle.color, c = b ? c.itemStyle.color : g, h = b ? a.legendColor || a.color || "#CCC" : g, g = a.options && a.options.marker, i = {
                fill: h
            };
            d && d.css({
                fill: c,
        ...
        renderItem: function(a) {
            ...
            q || (a.legendGroup = c.g("legend-item").attr({
                zIndex: 1
            }).add(this.scrollGroup), G.drawLegendSymbol(this, a), a.legendItem = q = c.text(d.labelFormat ? Ja(d.labelFormat, a) : d.labelFormatter.call(a), l ? f + g : -g, this.baseline, r).css(y(a.visible ? h : i)).attr({
                align: l ? "left" : "right",
                zIndex: 2
            }).add(a.legendGroup), this.setItemEvents && this.setItemEvents(a, q, r, h, i), 
            ...
            e && this.itemX - u + f > (m || b.chartWidth - 2 * k - u - d.x) && (this.itemX = u, 
            this.itemY += p + this.lastLineHeight + n, this.lastLineHeight = 0);
        ...
        getAllItems: function() {
            ...
            q(this.chart.series, function(b) {
                var c = b.options;
                o(c.showInLegend, t(c.linkedTo) ? !1 : r, !0) && (a = a.concat(b.legendItems || ("point" === c.legendType ? b.data : b)));
            });
            return a;
        },
        render: function() {
            var e, f, g, h, a = this, b = a.chart, c = b.renderer, d = a.group, i = a.box, k = a.options, j = a.padding, l = k.borderWidth, m = k.backgroundColor;
            ...
            if (l || m) {
                ...
                i ? g > 0 && h > 0 && (i[i.isNew ? "attr" : "animate"](i.crisp({
                    width: g,
                    height: h
                })), i.isNew = !1) : (a.box = i = c.rect(0, 0, g, h, k.borderRadius, l || 0).attr({
        ...
        handleOverflow: function(a) {
            var h, p, b = this, c = this.chart, d = c.renderer, e = this.options, f = e.y, f = c.spacingBox.height + ("top" === e.verticalAlign ? -f : f) - this.padding, g = e.maxHeight, i = this.clipRect, k = e.navigation, j = o(k.animation, !0), l = k.arrowSize || 12, m = this.nav, n = this.pages, u = this.allItems;
            ...
            if (a > f && !e.useHTML) {
                ...
                q(u, function(a, b) {
                    ...
                    (!e || c - n[e - 1] > h && (p || c) !== n[e - 1]) && (n.push(p || c), e++);
        ...
        scroll: function(a, b) {
            ...
            e > d && (e = d);
            e > 0 && (b !== r && Ya(b, this.chart), this.nav.attr({
                translateX: k,
    ...
    Q = P.LegendSymbolMixin = {
        ...
        drawLineMarker: function(a) {
            ...
            d = a.symbolWidth;
            var g, e = this.chart.renderer, f = this.legendGroup, a = a.baseline - s(.3 * e.fontMetrics(a.options.itemStyle.fontSize).b);
            if (b.lineWidth) {
                g = {
    ...
    va.prototype = {
        ...
        redraw: function(a) {
            var g, h, b = this.axes, c = this.series, d = this.pointer, e = this.legend, f = this.isDirtyLegend, i = this.isDirtyBox, k = c.length, j = k, l = this.renderer, m = l.isHidden(), n = [];
            Ya(a, this);
            ...
            if (h) for (j = k; j--; ) (a = c[j], a.options.stacking) && (a.isDirty = !0);
            q(c, function(a) {
            ...
            if (this.hasCartesianSeries) {
                this.isResizing || (this.maxTicks = null, q(b, function(a) {
                    a.setScale();
                }));
        ...
        getChartSize: function() {
            ...
            t(b) || (this.containerWidth = nb(c, "width"));
            t(a) || (this.containerHeight = nb(c, "height"));
        ...
        getContainer: function() {
            ...
            e = "highcharts-" + Ab++;
            Oa(a) && (this.renderTo = a = B.getElementById(a));
            a || qa(13, !0);
        ...
        getMargins: function() {
            var b, a = this.spacing, c = this.legend, d = this.margin, e = this.options.legend, f = o(e.margin, 20), g = e.x, h = e.y, i = e.align, k = e.verticalAlign, j = this.titleOffset;
            this.resetMargins();
            b = this.axisOffset;
            j && !t(d[0]) && (this.plotTop = w(this.plotTop, j + this.options.title.margin + a[0]));
            c.display && !e.floating && ("right" === i ? t(d[1]) || (this.marginRight = w(this.marginRight, c.legendWidth - g + f + a[1])) : "left" === i ? t(d[3]) || (this.plotLeft = w(this.plotLeft, c.legendWidth + g + f + a[3])) : "top" === k ? t(d[0]) || (this.plotTop = w(this.plotTop, c.legendHeight + h + f + a[0])) : "bottom" !== k || t(d[2]) || (this.marginBottom = w(this.marginBottom, c.legendHeight - h + f + a[2])));
        ...
        setSize: function(a, b, c) {
            ...
            t(a) && (d.chartWidth = e = w(0, s(a)), d.hasUserSize = !!e);
            t(b) && (d.chartHeight = f = w(0, s(b)));
            (Ca ? ob : E)(d.container, {
                width: e + "px",
                height: f + "px"
            }, Ca);
        ...
        setChartSize: function(a) {
            var i, k, j, l, b = this.inverted, c = this.renderer, d = this.chartWidth, e = this.chartHeight, f = this.options.chart, g = this.spacing, h = this.clipOffset;
        ...
        drawChartBox: function() {
            ...
            j && (f ? f.animate(x) : this.plotBackground = b.rect(p, u, o, q, 0).attr({
                fill: j
            }).add().shadow(a.plotShadow));
            l && (h ? h.animate(x) : this.plotBGImage = b.image(l, p, u, o, q).add());
            r ? r.animate({
                width: s.width,
                height: s.height
        ...
        linkSeries: function() {
            ...
            q(b, function(b) {
                ...
                Oa(d) && (d = ":previous" === d ? a.series[b.index - 1] : a.get(d)) && (d.linkedSeries.push(b), 
                b.linkedParent = d);
            });
        },
        ...
        destroy: function() {
            ...
            d && (d.innerHTML = "", R(d), f && Sa(d));
            for (e in a) delete a[e];
        },
        isReadyToRender: function() {
            var a = this;
            return !ca && X == X.top && "complete" !== B.readyState || ja && !X.canvg ? (ja ? Vb.push(function() {
                a.firstRender();
            }, a.options.global.canvasToolsURL) : B.attachEvent("onreadystatechange", function() {
                B.detachEvent("onreadystatechange", a.firstRender);
                "complete" === B.readyState && a.firstRender();
            }), !1) : !0;
        },
        firstRender: function() {
            ...
            if (a.isReadyToRender()) {
                ...
                a.linkSeries();
                N(a, "beforeRender");
                P.Pointer && (a.pointer = new Xa(a, b));
                a.render();
                a.renderer.draw();
                c && c.apply(a, [ a ]);
    ...
    ea = P.CenteredSeriesMixin = {
        getCenter: function() {
            var d, h, a = this.options, b = this.chart, c = 2 * (a.slicedOffset || 0), e = b.plotWidth - 2 * c, f = b.plotHeight - 2 * c, b = a.center, a = [ o(b[0], "50%"), o(b[1], "50%"), a.size || "100%", a.innerSize || 0 ], g = z(e, f);
    ...
    za.prototype = {
        ...
        applyOptions: function(a, b) {
            ...
            d && (this.y = this[d]);
            this.x === r && c && (this.x = b === r ? c.autoIncrement() : b);
            return this;
        },
        optionsToObject: function(a) {
            var b = {}, c = this.series, d = c.pointArrayMap || [ "y" ], e = d.length, f = 0, g = 0;
            if ("number" == typeof a || null === a) b[d[0]] = a; else if (Pa(a)) {
                if (a.length > e) {
                    c = typeof a[0];
        ...
        destroy: function() {
            ...
            a.pointCount--;
            b && (this.setState(), pa(b, this), !b.length) && (a.hoverPoints = null);
            this === a.hoverPoint && this.onMouseOut();
            (this.graphic || this.dataLabel) && (R(this), this.destroyElements());
    ...
    K.prototype = {
        ...
        bindAxes: function() {
            ...
            q(a.axisTypes || [], function(e) {
                q(c[e], function(c) {
                    d = c.options;
                    (b[e] === d.index || b[e] !== r && b[e] === d.id || b[e] === r && 0 === d.index) && (c.series.push(a), 
                    a[e] = c, c.isDirty = !0);
                });
        ...
        getColor: function() {
            ...
            e || a.colorByPoint || (t(b._colorIndex) ? a = b._colorIndex : (b._colorIndex = d.color, 
            a = d.color++), e = c[a]);
            this.color = e;
        ...
        getSymbol: function() {
            ...
            this.symbol || (t(a._symbolIndex) ? a = a._symbolIndex : (a._symbolIndex = c.symbol, 
        ...
        setData: function(a, b, c, d) {
            var h, e = this, f = e.points, g = f && f.length || 0, i = e.options, k = e.chart, j = null, l = e.xAxis, m = l && !!l.categories, n = e.tooltipPoints, p = i.turboThreshold, u = this.xData, s = this.yData, G = (h = e.pointArrayMap) && h.length, a = a || [];
            h = a.length;
            b = o(b, !0);
            if (d === !1 || !h || g !== h || e.cropped || e.hasGroupedData) {
                ...
                if (p && h > p) {
                    for (c = 0; null === j && h > c; ) j = a[c], c++;
                    if (la(j)) {
                        m = o(i.pointStart, 0);
                        i = o(i.pointInterval, 1);
                        for (c = 0; h > c; c++) u[c] = m, s[c] = a[c], m += i;
                        e.xIncrement = m;
                    } else if (Pa(j)) if (G) for (c = 0; h > c; c++) i = a[c], u[c] = i[0], s[c] = i.slice(1, G + 1); else for (c = 0; h > c; c++) i = a[c], 
                    u[c] = i[0], s[c] = i[1]; else qa(12);
                } else for (c = 0; h > c; c++) a[c] !== r && (i = {
                    series: e
        ...
        processData: function(a) {
            ...
            e = 0;
            var f, g, m, n, h = this.xAxis, i = this.options, k = i.cropThreshold, j = 0, l = this.isCartesian;
            if (l && !this.isDirty && !h.isDirty && !this.yAxis.isDirty && !a) return !1;
            l && this.sorted && (!k || d > k || this.forceCrop) && (m = h.min, n = h.max, m > b[d - 1] || b[0] > n ? (b = [], 
            c = []) : (m > b[0] || b[d - 1] > n) && (e = this.cropData(this.xData, this.yData, m, n), 
            b = e.xData, c = e.yData, e = e.start, f = !0, j = b.length));
            for (d = b.length - 1; d >= 0; d--) a = b[d] - b[d - 1], !f && b[d] > m && n > b[d] && j++, 
            a > 0 && (g === r || g > a) ? g = a : 0 > a && this.requireSorting && qa(15);
            this.cropped = f;
            this.cropStart = e;
        ...
        generatePoints: function() {
            var c, i, j, m, a = this.options.data, b = this.data, d = this.processedXData, e = this.processedYData, f = this.pointClass, g = d.length, h = this.cropStart || 0, k = this.hasGroupedData, l = [];
            b || k || (b = [], b.length = a.length, b = this.data = b);
            for (m = 0; g > m; m++) i = h + m, k ? l[m] = new f().init(this, [ d[m] ].concat(ma(e[m]))) : (b[i] ? j = b[i] : a[i] !== r && (b[i] = j = new f().init(this, a[i], d[m])), 
            l[m] = j);
            if (b && (g !== (c = b.length) || k)) for (m = 0; c > m; m++) (m === h && !k && (m += g), 
            b[m]) && (b[m].destroyElements(), b[m].plotX = r);
            this.data = b;
            this.points = l;
        },
        getExtremes: function(a) {
            ...
            var i, k, j, l, g = d.min, h = d.max, a = a || this.stackedYData || this.processedYData;
            d = a.length;
            for (l = 0; d > l; l++) if (k = c[l], j = a[l], i = null !== j && j !== r && (!b.isLog || j.length || j > 0), 
            k = this.getExtremesFromAll || this.cropped || (c[l + 1] || k) >= g && h >= (c[l - 1] || k), 
            i && k) if (i = j.length) for (;i--; ) null !== j[i] && (e[f++] = j[i]); else e[f++] = j;
        ...
        translate: function() {
            ...
            this.generatePoints();
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, k = "between" === i || la(i), j = a.threshold, a = 0; g > a; a++) {
                var l = f[a], m = l.x, n = l.y, p = l.low, u = b && e.stacks[(this.negStacks && j > n ? "-" : "") + this.stackKey];
                e.isLog && 0 >= n && (l.y = n = null);
                l.plotX = c.translate(m, 0, 0, 0, 1, i, "flags" === this.type);
                b && this.visible && u && u[m] && (u = u[m], n = u.points[this.index + "," + a], 
                p = n[0], n = n[1], 0 === p && (p = o(j, e.min)), e.isLog && 0 >= p && (p = null), 
                l.total = l.stackTotal = u.total, l.percentage = u.total && 100 * (l.y / u.total), 
                l.stackY = n, u.setOffset(this.pointXOffset || 0, this.barW || 0));
                l.yBottom = t(p) ? e.translate(p, 0, 1, 0, 1) : null;
                h && (n = this.modifyValue(n, l));
                l.plotY = "number" == typeof n && 1/0 !== n ? e.translate(n, 0, 1, 0, 1) : r;
        ...
        animate: function(a) {
            ...
            d && !fa(d) && (d = T[this.type].animation);
        ...
        afterAnimate: function() {
            ...
            if (c && this.options.clip !== !1) {
                b && d || c.clip(d ? a.renderer.clipRect(d) : a.clipRect);
        ...
        drawPoints: function() {
            var a, d, e, f, g, h, i, k, j, b = this.points, c = this.chart;
            d = this.options.marker;
            var m, l = this.pointAttr[""], n = this.markerGroup, p = o(d.enabled, this.activePointCount < .5 * this.xAxis.len / d.radius);
            if (d.enabled !== !1 || this._hasPointMarkers) for (f = b.length; f--; ) g = b[f], 
            d = S(g.plotX), e = g.plotY, j = g.graphic, i = g.marker || {}, a = p && i.enabled === r || i.enabled, 
            m = c.isInsidePlot(s(d), e, c.inverted), a && e !== r && !isNaN(e) && null !== g.y ? (a = g.pointAttr[g.selected ? "select" : ""] || l, 
            h = a.r, i = o(i.symbol, this.symbol), k = 0 === i.indexOf("url"), j ? j[m ? "show" : "hide"](!0).animate(v({
                x: d - h,
                y: e - h
            }, j.symbolName ? {
                width: 2 * h,
                height: 2 * h
            } : {})) : m && (h > 0 || k) && (g.graphic = c.renderer.symbol(i, d - h, e - h, 2 * h, 2 * h).attr(a).add(n))) : j && (g.graphic = j.destroy());
        },
        ...
        getAttribs: function() {
            var f, a = this, b = a.options, c = T[a.type].marker ? b.marker : b, d = c.states, e = d.hover, g = a.color;
            f = {
                stroke: g,
                fill: g
            };
            var i, j, h = a.points || [], k = [], l = a.pointAttrToOptions;
            ...
            if (!i || i > g || j) for (;g--; ) {
                ...
                if (j) {
                    ...
                    d = c.states || {};
                    f = d.hover = d.hover || {};
                    b.marker || (f.color = f.color || !i.options.color && e.color || Fa(i.color).brighten(f.brightness || e.brightness).get());
                    f = {
                        color: i.color
                    };
                    p || (f.fillColor = i.color);
        ...
        destroy: function() {
            var d, e, g, h, i, a = this, b = a.chart, c = /AppleWebKit\/533/.test(Da), f = a.data || [];
            N(a, "destroy");
            R(a);
            q(a.axisTypes || [], function(b) {
                (i = a[b]) && (pa(i.series, a), i.isDirty = i.forceRedraw = !0);
            });
        ...
        clipNeg: function() {
            ...
            if (d && (f || g)) {
                ...
                b.inverted && (a.height = j.y = b.plotWidth - d, c.isVML && (a = {
        ...
        render: function() {
            var c, a = this, b = a.chart, d = a.options, e = (c = d.animation) && !!a.animate && b.renderer.isSVG && o(c.duration, 500) || 0, f = a.visible ? "visible" : "hidden", g = d.zIndex, h = a.hasRendered, i = b.seriesGroup;
    ...
    K.prototype.setStackedPoints = function() {
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            var n, p, u, o, q, x, a = this.processedXData, b = this.processedYData, c = [], d = b.length, e = this.options, f = e.threshold, g = e.stack, e = e.stacking, h = this.stackKey, i = "-" + h, k = this.negStacks, j = this.yAxis, l = j.stacks, m = j.oldStacks;
            for (o = 0; d > o; o++) {
                q = a[o];
                x = b[o];
                u = this.index + "," + o;
                p = (n = k && f > x) ? i : h;
                l[p] || (l[p] = {});
                l[p][q] || (m[p] && m[p][q] ? (l[p][q] = m[p][q], l[p][q].total = null) : l[p][q] = new Rb(j, j.options.stackLabels, n, q, g));
                p = l[p][q];
                p.points[u] = [ p.cum || 0 ];
                "percent" === e ? (n = n ? h : i, k && l[n] && l[n][q] ? (n = l[n][q], p.total = n.total = w(n.total, p.total) + M(x) || 0) : p.total = ha(p.total + (M(x) || 0))) : p.total = ha(p.total + (x || 0));
                p.cum = (p.cum || 0) + (x || 0);
                p.points[u].push(p.cum);
                c[o] = p.cum;
            }
            "percent" === e && (j.usePercentage = !0);
            this.stackedYData = c;
            j.oldStacks = {};
        }
    };
    K.prototype.setPercentStacks = function() {
        ...
        q([ b, "-" + b ], function(b) {
            ...
            g = e) && (h = h.total ? 100 / h.total : 0, g[0] = ha(g[0] * h), g[1] = ha(g[1] * h), 
    ...
    v(va.prototype, {
        ...
        showLoading: function(a) {
            ...
            c || (this.loadingDiv = c = $(Ta, {
                className: "highcharts-loading"
            }, v(d.style, {
                zIndex: 10,
                display: Y
            }), this.container), this.loadingSpan = $("span", null, d.labelStyle, c));
            this.loadingSpan.innerHTML = a || b.lang.loading;
            this.loadingShown || (E(c, {
                opacity: 0,
                display: "",
    ...
    v(za.prototype, {
        update: function(a, b, c) {
            var g, d = this, e = d.series, f = d.graphic, h = e.data, i = e.chart, k = e.options, b = o(b, !0);
            d.firePointEvent("update", {
                ...
                "point" === k.legendType && i.legend.destroyItem(d);
                b && i.redraw(c);
            });
        },
        remove: function(a, b) {
    ...
    v(K.prototype, {
        addPoint: function(a, b, c, d) {
            var m, e = this.options, f = this.data, g = this.graph, h = this.area, i = this.chart, k = this.xAxis && this.xAxis.names, j = g && g.shift || 0, l = e.data, n = this.xData;
            Ya(d, i);
        ...
        remove: function(a, b) {
            ...
            c.isRemoving || (c.isRemoving = !0, N(c, "remove", null, function() {
                c.destroy();
        ...
        update: function(a, b) {
            var f, c = this.chart, d = this.type, e = C[d].prototype, a = y(this.userOptions, {
                animation: !1,
                index: this.index,
    ...
    var ta = ga(K, {
        type: "area",
        getSegments: function() {
            var h, i, l, m, n, a = [], b = [], c = [], d = this.xAxis, e = this.yAxis, f = e.stacks[this.stackKey], g = {}, k = this.points, j = this.options.connectNulls;
            if (this.options.stacking && !this.cropped) {
                for (m = 0; k.length > m; m++) g[k[m].x] = k[m];
                for (n in f) null !== f[n].total && c.push(+n);
                c.sort(function(a, b) {
                    return a - b;
                });
                q(c, function(a) {
                    (!j || g[a] && null !== g[a].y) && (g[a] ? b.push(g[a]) : (h = d.translate(a), l = f[a].percent ? f[a].total ? 100 * f[a].cum / f[a].total : 0 : f[a].cum, 
        ...
        getSegmentPath: function(a) {
            var d, b = K.prototype.getSegmentPath.call(this, a), c = [].concat(b), e = this.options;
            d = b.length;
        ...
        drawGraph: function() {
            ...
            q(f, function(d) {
                ...
                f ? f.animate({
                    ...
                    fill: o(d[2], Fa(d[1]).setOpacity(o(c.fillOpacity, .75)).get()),
                    zIndex: 0
                }).add(a.group);
            });
        },
    ...
    Aa = ga(K, {
        ...
        getPointSpline: function(a, b, c) {
            var h, i, k, j, d = b.plotX, e = b.plotY, f = a[c - 1], g = a[c + 1];
            if (f && g) {
                a = f.plotY;
                k = g.plotX;
                var l, g = g.plotY;
                ...
                i += l;
                j += l;
                i > a && i > e ? (i = w(a, e), j = 2 * e - i) : a > i && e > i && (i = z(a, e), 
                j = 2 * e - i);
                j > g && j > e ? (j = w(g, e), i = 2 * e - j) : g > j && e > j && (j = z(g, e), 
                i = 2 * e - j);
                b.rightContX = k;
                b.rightContY = j;
            }
    ...
    Aa = ga(K, {
        ...
        translate: function() {
            var a = this, b = a.chart, c = a.options, d = a.borderWidth = o(c.borderWidth, a.activePointCount > .5 * a.xAxis.len ? 0 : 1), e = a.yAxis, f = a.translatedThreshold = e.getThreshold(c.threshold), g = o(c.minPointLength, 5), c = a.getColumnMetrics(), h = c.width, i = a.barW = Va(w(h, 1 + 2 * d)), k = a.pointXOffset = c.offset, j = -(d % 2 ? .5 : 0), l = d % 2 ? .5 : 1;
            b.renderer.isVML && b.inverted && (l += 1);
            K.prototype.translate.apply(a);
            q(a.points, function(c) {
                var x, d = o(c.yBottom, f), p = z(w(-999 - d, c.plotY), e.len + 999 + d), u = c.plotX + k, q = i, r = z(p, d);
                x = w(p, d) - r;
                g > M(x) && g && (x = g, r = s(M(r - f) > g ? d - g : f - (f >= e.translate(c.y, 0, 1, 0, 1) ? g : 0)));
                c.barX = u;
                c.pointWidth = h;
        ...
        drawPoints: function() {
            ...
            q(a.points, function(i) {
                ...
                k === r || isNaN(k) || null === i.y ? j && (i.graphic = j.destroy()) : (f = i.shapeArgs, 
                h = t(a.borderWidth) ? {
                    "stroke-width": a.borderWidth
                } : {}, g = i.pointAttr[i.selected ? "select" : ""] || a.pointAttr[""], j ? (eb(j), 
                j.attr(h)[e > b.pointCount ? "animate" : "attr"](y(f))) : i.graphic = d[i.shapeType](f).attr(g).attr(h).add(a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius));
            });
        },
        animate: function(a) {
            var b = this.yAxis, c = this.options, d = this.chart.inverted, e = {};
            ca && (a ? (e.scaleY = .001, a = z(b.pos + b.len, w(b.pos, b.toPixels(c.threshold))), 
    ...
    J = {
        ...
        translate: function(a) {
            this.generatePoints();
            var f, g, h, m, p, b = 0, c = this.options, d = c.slicedOffset, e = d + c.borderWidth, i = c.startAngle || 0, k = this.startAngleRad = ra / 180 * (i - 90), i = (this.endAngleRad = ra / 180 * (o(c.endAngle, i + 360) - 90)) - k, j = this.points, l = c.dataLabels.distance, c = c.ignoreHiddenPoint, n = j.length;
            ...
            for (m = 0; n > m; m++) {
                ...
                p.half = -ra / 2 > h || h > ra / 2 ? 1 : 0;
                p.angle = h;
                e = z(e, l / 2);
                p.labelPos = [ a[0] + f + da(h) * l, a[1] + g + ia(h) * l, a[0] + f + da(h) * e, a[1] + g + ia(h) * e, a[0] + f, a[1] + g, 0 > l ? "center" : p.half ? "right" : "left", h ];
            }
        },
        drawGraph: null,
        drawPoints: function() {
    ...
    K.prototype.drawDataLabels = function() {
        ...
        i = a.plotGroup("dataLabelsGroup", "data-labels", "hidden", d.zIndex || 6), !a.hasRendered && o(d.defer, !0) && (i.attr({
            opacity: 0
            ...
            var e, m, n, l = b.dataLabel, p = b.connector, u = !0;
            ...
            if (l && !e) b.dataLabel = l.destroy(); else if (e) {
                ...
                if (l) t(h) ? (l.attr({
                    text: h
                }), u = !1) : (b.dataLabel = l = l.destroy(), p) && (b.connector = p.destroy()); else if (t(h)) {
                    l = {
    ...
    K.prototype.alignDataLabel = function(a, b, c, d, e) {
        ...
        (a = this.visible && (a.series.forceDL || f.isInsidePlot(h, s(i), g) || d && f.isInsidePlot(h, g ? d.x + 1 : d.y + d.height - 1, g))) && (d = v({
            x: g ? f.plotWidth - i : h,
        ...
        }, b[e ? "attr" : "animate"](g)) : (b.align(c, null, d), g = b.alignAttr, "justify" === o(c.overflow, "justify") ? this.justifyDataLabel(b, c, g, k, d, e) : o(c.crop, !0) && (a = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + k.width, g.y + k.height))));
        a || (b.attr({
            y: -999
        }), b.placed = !1);
    };
    K.prototype.justifyDataLabel = function(a, b, c, d, e, f) {
        var k, j, g = this.chart, h = b.align, i = b.verticalAlign;
        k = c.x;
        0 > k && ("right" === h ? b.align = "left" : b.x = -k, j = !0);
        k = c.x + d.width;
        k > g.plotWidth && ("left" === h ? b.align = "right" : b.x = g.plotWidth - k, j = !0);
        k = c.y;
        0 > k && ("bottom" === i ? b.verticalAlign = "top" : b.y = -k, j = !0);
        k = c.y + d.height;
        k > g.plotHeight && ("top" === i ? b.verticalAlign = "bottom" : b.y = g.plotHeight - k, 
        j = !0);
        j && (a.placed = !f, a.align(b, null, e));
    };
    C.pie && (C.pie.prototype.drawDataLabels = function() {
        var c, i, k, r, G, x, t, y, z, A, B, D, a = this, b = a.data, d = a.chart, e = a.options.dataLabels, f = o(e.connectorPadding, 10), g = o(e.connectorWidth, 1), h = d.plotWidth, d = d.plotHeight, j = o(e.softConnector, !0), l = e.distance, m = a.center, n = m[2] / 2, p = m[1], u = l > 0, v = [ [], [] ], U = [ 0, 0, 0, 0 ], I = function(a, b) {
            return b.y - a.y;
        };
        if (a.visible && (e.enabled || a._hasPointLabels)) {
            ...
            B++;
            for (B = 2; B--; ) {
                var F, b = [], H = [], C = v[B], E = C.length;
                a.sortByAngle(C, B - .5);
                if (l > 0) {
                    for (D = p - n - l; p + n + l >= D; D += t) b.push(D);
                    G = b.length;
                    if (E > G) {
                        c = [].concat(C);
                        c.sort(I);
                    ...
                    for (D = 0; E > D; D++) {
                        ...
                        c = 9999;
                        var L, J;
                        for (J = 0; G > J; J++) L = M(b[J] - x[1]), c > L && (c = L, F = J);
                        if (D > F && null !== b[D]) F = D; else for (E - D + F > G && null !== b[D] && (F = G - E + D); null === b[F]; ) F++;
                        H.push({
                            i: F,
                            y: b[F]
                        });
                ...
                for (D = 0; E > D; D++) {
                    ...
                    c = x[1];
                    l > 0 ? (G = H.pop(), F = G.i, z = G.y, c > z && null !== b[F + 1] || z > c && null !== b[F - 1]) && (z = c) : z = c;
                    y = e.justify ? m[0] + (B ? -1 : 1) * (n + l) : a.getX(0 === F || F === b.length - 1 ? c : z, B);
                    r._attr = {
                        visibility: A,
                        align: x[6]
                    };
                    ...
                    r.connX = y;
                    r.connY = z;
                    null === this.options.size && (G = r.width, f > y - G ? U[3] = w(s(G - y + f), U[3]) : y + G > h - f && (U[1] = w(s(y + G - h + f), U[1])), 
                    0 > z - t / 2 ? U[0] = w(s(-z + t / 2), U[0]) : z + t / 2 > d && (U[2] = w(s(z + t / 2 - d), U[2])));
                }
            }
            (0 === Ba(U) || this.verifyDataLabelOverflow(U)) && (this.placeDataLabels(), u && g && q(this.points, function(b) {
                i = b.connector;
                x = b.labelPos;
                (r = b.dataLabel) && r._pos ? (A = r._attr.visibility, y = r.connX, z = r.connY, 
                k = j ? [ "M", y + ("left" === x[6] ? 5 : -5), z, "C", y, z, 2 * x[2] - x[4], 2 * x[3] - x[5], x[2], x[3], "L", x[4], x[5] ] : [ "M", y + ("left" === x[6] ? 5 : -5), z, "L", x[2], x[3], "L", x[4], x[5] ], 
                i ? (i.animate({
                    d: k
        ...
        null !== d[0] ? e = w(b[2] - w(a[1], a[3]), c) : (e = w(b[2] - a[1] - a[3], c), 
        b[0] += (a[3] - a[1]) / 2);
        null !== d[1] ? e = w(z(e, b[2] - w(a[0], a[2])), c) : (e = w(z(e, b[2] - a[0] - a[2]), c), 
        b[1] += (a[0] - a[2]) / 2);
        b[2] > e ? (b[2] = e, this.translate(b), q(this.points, function(a) {
            a.dataLabel && (a.dataLabel._pos = null);
        }), this.drawDataLabels && this.drawDataLabels()) : f = !0;
        return f;
    });
    C.column && (C.column.prototype.alignDataLabel = function(a, b, c, d, e) {
    ...
    var gb = P.TrackerMixin = {
        drawTrackerPoint: function() {
            var a = this, b = a.chart, c = b.pointer, d = a.options.cursor, e = d && {
                ...
                e !== r && e !== b.hoverPoint && e.onMouseOver(c);
            };
        ...
        drawTrackerGraph: function() {
            var m, a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath : a.graphPath), e = d.length, f = a.chart, g = f.pointer, h = f.renderer, i = f.options.tooltip.snap, k = a.tracker, j = b.cursor, l = j && {
                cursor: j
            }, j = a.singlePoints, n = function() {
            ...
            for (m = 0; j.length > m; m++) e = j[m], d.push("M", e.plotX - i, e.plotY, "L", e.plotX + i, e.plotY);
            k ? k.attr({
                d: d
                ...
                ab && a.on("touchstart", n);
            }));
        }
    };
    C.column && (Aa.prototype.drawTracker = gb.drawTrackerPoint);
    C.pie && (C.pie.prototype.drawTracker = gb.drawTrackerPoint);
    C.scatter && (ta.prototype.drawTracker = gb.drawTrackerPoint);
    v(pb.prototype, {
    ...
    v(va.prototype, {
        showResetZoom: function() {
            var a = this, b = F.lang, c = a.options.chart.resetZoomButton, d = c.theme, e = d.states, f = "chart" === c.relativeTo ? null : "plotBox";
        ...
        zoom: function(a) {
            ...
            d && !e ? this.showResetZoom() : !d && fa(e) && (this.resetZoomButton = e.destroy());
        ...
        pan: function(a, b) {
            ...
            q("xy" === b ? [ 1, 0 ] : [ 1 ], function(b) {
                ...
                h.series.length && l > z(j.dataMin, j.min) && w(j.dataMax, j.max) > i && (h.setExtremes(l, i, !1, !1, {
                    trigger: "pan"
                }), e = !0);
    ...
    v(za.prototype, {
        select: function(a, b) {
            ...
            c.firePointEvent(a ? "select" : "unselect", {
                ...
                b || q(e.getSelectedPoints(), function(a) {
                    a.selected && a !== c && (a.selected = a.options.selected = !1, d.options.data[wa(a, d.data)] = a.options, 
        ...
        onMouseOut: function() {
            ...
            b && -1 !== wa(this, b) || (this.firePointEvent("mouseOut"), this.setState(), a.hoverPoint = null);
        },
        ...
        setState: function(a, b) {
            var p, c = this.plotX, d = this.plotY, e = this.series, f = e.options.states, g = T[e.type].marker && e.options.marker, h = g && !g.enabled, i = g && g.states[a], k = i && i.enabled === !1, j = e.stateMarkerGraphic, l = this.marker || {}, m = e.chart, n = e.halo, a = a || "";
            p = this.pointAttr[a] || e.pointAttr[a];
            if (!(a === this.state && !b || this.selected && "select" !== a || f[a] && f[a].enabled === !1 || a && (k || h && i.enabled === !1) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
                if (this.graphic) g = g && this.graphic.symbolName && p.r, this.graphic.attr(y(p, g ? {
                    ...
                    a && i && (g = i.radius, l = l.symbol || e.symbol, j && j.currentSymbol !== l && (j = j.destroy()), 
                    j ? j[b ? "animate" : "attr"]({
                        x: c - g,
                        y: d - g
                    }) : l && (e.stateMarkerGraphic = j = m.renderer.symbol(l, c - g, d - g, 2 * g, 2 * g).attr(p).add(e.markerGroup), 
                    j.currentSymbol = l));
                    j && j[a && m.isInsidePlot(c, d, m.inverted) ? "show" : "hide"]();
                }
                if ((c = f[a] && f[a].halo) && c.size) {
                    n || (e.halo = n = m.renderer.path().add(e.seriesGroup));
                    n.attr(v({
    ...
    v(K.prototype, {
        ...
        setTooltipPoints: function(a) {
            var c, d, h, i, b = [], e = this.xAxis, f = e && e.getExtremes(), g = e ? e.tooltipLen || e.len : this.chart.plotSizeX, k = [];
            if (!(this.options.enableMouseTracking === !1 || this.singularTooltips)) {
                ...
                for (i = 0; a > i; i++) if (e = b[i], c = e.x, c >= f.min && f.max >= c) {
                    h = b[i + 1];
                    c = d === r ? 0 : d + 1;
                    for (d = b[i + 1] ? z(w(0, S((e.clientX + (h ? h.wrappedClientX || h.clientX : g)) / 2)), g) : g; c >= 0 && d >= c; ) k[c++] = e;
                }
    ...
    O(L.prototype, "getTimeTicks", function(a, b, c, d, e, f, g, h) {
        var j, m, n, p, i = 0, k = 0, l = {}, o = [], q = -Number.MAX_VALUE, s = this.options.tickPixelInterval;
        if (!this.options.ordinal || !f || 3 > f.length || c === r) return a.call(this, b, c, d, e);
        for (n = f.length; n > k; k++) {
            p = k && f[k - 1] > d;
            c > f[k] && (i = k);
            if (k === n - 1 || f[k + 1] - f[k] > 5 * g || p) {
                if (f[k] > q) {
                    for (j = a.call(this, b, f[i], f[k], e); j.length && q >= j[0]; ) j.shift();
        ...
        if (h && a.unitRange <= H.hour) {
            k = o.length - 1;
            for (i = 1; k > i; i++) new Date(o[i] - La)[Ua]() !== new Date(o[i - 1] - La)[Ua]() && (l[o[i]] = "day", 
            m = !0);
            m && (l[o[0]] = "day");
            a.higherRanks = l;
        }
        o.info = a;
        if (h && t(s)) {
            var x, h = a = o.length, k = [];
            for (m = []; h--; ) i = this.translate(o[h]), x && (m[h] = x - i), k[h] = x = i;
            m.sort();
            m = m[S(m.length / 2)];
            .6 * s > m && (m = null);
            h = o[a - 1] > d ? a - 1 : a;
            for (x = void 0; h--; ) i = k[h], d = x - i, x && .8 * s > d && (null === m || .8 * m > d) ? (l[o[h]] && !l[o[h + 1]] ? (d = h + 1, 
            x = i) : d = h, o.splice(d, 1)) : x = i;
        }
        return o;
    });
    v(L.prototype, {
        beforeSetTickPositions: function() {
            ...
            if (this.options.ordinal) {
                ...
                c ? (this.ordinalPositions = b, c = this.val2lin(w(f, b[0]), !0), d = this.val2lin(z(e, b[b.length - 1]), !0), 
                this.ordinalSlope = e = (e - f) / (d - c), this.ordinalOffset = f - c * e) : this.ordinalPositions = this.ordinalSlope = this.ordinalOffset = r;
            }
        ...
        lin2val: function(a, b) {
            ...
            if (c) {
                ...
                if (b) 0 > a ? a = c[0] : a > f ? a = c[f] : (f = S(a), h = a - f); else for (;f--; ) if (g = d * f + e, 
                a >= g) {
                    d = d * (f + 1) + e;
                    h = (a - g) / (d - g);
                    break;
    ...
    O(va.prototype, "pan", function(a, b) {
        var c = this.xAxis[0], d = b.chartX, e = !1;
        if (c.options.ordinal && c.series.length) {
            var p, f = this.mouseDownX, g = c.getExtremes(), h = g.dataMax, i = g.min, k = g.max, j = this.hoverPoints, l = c.closestPointRange, f = (f - d) / (c.translationSlope * (c.ordinalSlope || l)), m = {
                ordinalPositions: c.getExtendedPositions()
            }, l = c.lin2val, n = c.val2lin;
            m.ordinalPositions ? M(f) > 1 && (j && q(j, function(a) {
                a.setState();
            }), 0 > f ? (j = m, p = c.ordinalPositions ? c : m) : (j = c.ordinalPositions ? c : m, 
            p = m), m = p.ordinalPositions, h > m[m.length - 1] && m.push(h), this.fixedRange = k - i, 
    ...
    O(K.prototype, "getSegments", function(a) {
        ...
        a.apply(this, Array.prototype.slice.call(arguments, 1));
        c && (b = this.segments, q(b, function(a, f) {
    ...
    ba.groupData = function(a, b, c, d) {
        var k, j, o, e = this.data, f = this.options.data, g = [], h = [], i = a.length, l = !!b, m = [ [], [], [], [] ], d = "function" == typeof d ? d : Na[d], n = this.pointArrayMap, p = n && n.length;
        for (o = 0; i >= o; o++) if (a[o] >= c[0]) break;
        for (;i >= o; o++) {
            for (;c[1] !== r && a[o] >= c[1] || o === i; ) if (k = c.shift(), j = d.apply(0, m), 
            j !== r && (g.push(k), h.push(j)), m[0] = [], m[1] = [], m[2] = [], m[3] = [], o === i) break;
            if (o === i) break;
            if (n) {
                k = this.cropStart + o;
                ...
                var q;
                for (j = 0; p > j; j++) q = k[n[j]], "number" == typeof q ? m[j].push(q) : null === q && (m[j].hasNulls = !0);
            } else k = l ? b[o] : null, "number" == typeof k ? m[0].push(k) : null === k && (m[0].hasNulls = !0);
        }
        return [ g, h ];
    };
    ba.processData = function() {
        var e, a = this.chart, b = this.options, c = b.dataGrouping, d = c && o(c.enabled, a.options._stock);
        this.forceCrop = d;
        ...
        if (hc.apply(this, arguments) !== !1 && d) {
            ...
            if (k) {
                ...
                null === b.pointRange && (this.pointRange = k.info.totalRange);
                this.closestPointRange = k.info.totalRange;
                t(f[0]) && f[0] < a.dataMin && (a.dataMin = f[0]);
    ...
    J.tooltipHeaderFormatter = function(a) {
        ...
        if (g && "datetime" === g.options.type && d && la(a.key)) {
            b = b.currentDataGrouping;
            d = d.dateTimeLabelFormats;
            if (b) g = d[b.unitName], 1 === b.count ? e = g[0] : (e = g[1], f = g[2]); else if (!e && d) for (h in H) if (H[h] >= g.closestPointRange || H[h] <= H.day && a.key % H[h] > 0) {
                e = d[h][0];
                break;
            }
            e = ua(e, a.key);
    ...
    O(ba, "setOptions", function(a, b) {
        ...
        Wb[d] && (f || (f = y(lc, Wb[d])), c.dataGrouping = y(f, e.series && e.series.dataGrouping, e[d].dataGrouping, b.dataGrouping));
    ...
    J = ga(C.column, {
        ...
        drawPoints: function() {
            var c, d, e, f, g, h, i, k, a = this, b = a.chart;
            q(a.points, function(j) {
                j.plotY !== r && (i = j.graphic, c = j.pointAttr[j.selected ? "selected" : ""] || a.pointAttr[""], 
                f = c["stroke-width"] % 2 / 2, k = s(j.plotX) - f, g = s(j.shapeArgs.width / 2), 
                h = [ "M", k, s(j.yBottom), "L", k, s(j.plotY) ], null !== j.open && (d = s(j.plotOpen) + f, 
                h.push("M", k, d, "L", k - g, d)), null !== j.close && (e = s(j.plotClose) + f, 
                h.push("M", k, e, "L", k + g, e)), i ? i.animate({
                    d: h
    ...
    J = ga(J, {
        ...
        drawPoints: function() {
            var c, e, f, g, h, i, k, j, l, m, n, p, a = this, b = a.chart, d = a.pointAttr[""];
            q(a.points, function(o) {
                m = o.graphic;
                o.plotY !== r && (c = o.pointAttr[o.selected ? "selected" : ""] || d, j = c["stroke-width"] % 2 / 2, 
                l = s(o.plotX) - j, e = o.plotOpen, f = o.plotClose, g = V.min(e, f), h = V.max(e, f), 
                p = s(o.shapeArgs.width / 2), i = s(g) !== s(o.plotY), k = h !== o.yBottom, g = s(g) + j, 
                h = s(h) + j, n = [ "M", l - p, h, "L", l - p, g, "L", l + p, g, "L", l + p, h, "Z", "M", l, g, "L", l, i ? s(o.plotY) : g, "M", l, h, "L", l, k ? s(o.yBottom) : h, "Z" ], 
                m ? m.animate({
                    d: n
    ...
    C.flags = ga(C.column, {
        ...
        translate: function() {
            C.column.prototype.translate.apply(this);
            var d, e, j, l, m, a = this.chart, b = this.points, c = b.length - 1, f = this.options.onSeries, f = (d = f && a.get(f)) && d.options.step, g = d && d.points, h = g && g.length, i = this.xAxis, k = i.getExtremes();
            if (d && d.visible && h) {
                ...
                for (b.sort(function(a, b) {
                    ...
                    l >= d.x && (d.plotY = j.plotY, j.x < d.x && !f && (m = g[h + 1]) && m.plotY !== r && (d.plotY += (d.x - j.x) / (m.x - j.x) * (m.plotY - j.plotY)));
                    c--;
                    h++;
                    if (0 > c) break;
                }
            ...
            q(b, function(c, d) {
                c.plotY === r && (c.x >= k.min && c.x <= k.max ? c.plotY = a.chartHeight - i.bottom - (i.opposite ? i.height : 0) + i.offset - a.plotTop : c.shapeArgs = {});
                if ((e = b[d - 1]) && e.plotX === c.plotX) {
                    e.stackIndex === r && (e.stackIndex = 0);
                    c.stackIndex = e.stackIndex + 1;
                }
            });
        },
        drawPoints: function() {
            var a, e, f, i, k, j, l, n, o, b = this.pointAttr[""], c = this.points, d = this.chart.renderer, g = this.options, h = g.y, m = g.lineWidth % 2 / 2;
            for (k = c.length; k--; ) j = c[k], a = j.plotX > this.xAxis.len, e = j.plotX + (a ? m : -m), 
            l = j.stackIndex, i = j.options.shape || g.shape, f = j.plotY, f !== r && (f = j.plotY + h + m - (l !== r && l * g.stackDistance)), 
            n = l ? r : j.plotX + m, o = l ? r : j.plotY, l = j.graphic, f !== r && e >= 0 && !a ? (a = j.pointAttr[j.selected ? "select" : ""] || b, 
            l ? l.attr({
                x: e,
                y: f,
                r: a.r,
                ...
                width: g.width,
                height: g.height
            }).add(this.markerGroup).shadow(g.shadow), j.tooltipPos = [ e, f ]) : l && (j.graphic = l.destroy());
        },
    ...
    Wa === P.VMLRenderer && q([ "flag", "circlepin", "squarepin" ], function(a) {
    ...
    yb.prototype = {
        ...
        render: function(a, b, c, d) {
            var g, h, i, k, J, e = this.chart, f = e.renderer, j = this.scrollbarGroup, l = this.navigatorGroup, m = this.scrollbar, l = this.xAxis, n = this.scrollbarTrack, p = this.scrollbarHeight, q = this.scrollbarEnabled, r = this.navigatorOptions, t = this.scrollbarOptions, x = t.minWidth, v = this.height, y = this.top, A = this.navigatorEnabled, B = r.outlineWidth, C = B / 2, F = 0, D = this.outlineHeight, I = t.barBorderRadius, H = t.barBorderWidth, E = y + C;
            if (!isNaN(a)) {
                ...
                if (!(l.translate(d, !0) - l.translate(c, !0) < e.xAxis[0].minRange)) {
                    ...
                    if (!this.rendered) {
                        if (A) {
                            ...
                            r.maskInside || (this.rightShade = f.rect().attr({
                                fill: r.maskFill
                            }).add(l));
                        ...
                        q && (this.scrollbarGroup = j = f.g("scrollbar").add(), m = t.trackBorderWidth, 
                    ...
                    q && j && (this.drawScrollbarButton(0), this.drawScrollbarButton(1), j[e]({
                        translateX: i,
                        translateY: s(E + v)
                    }), n[e]({
                        width: k
                    }), g = p + b, h = a - H, x > h && (F = (x - h) / 2, h = x, g -= F), this.scrollbarPad = F, 
                    m[e]({
                        x: S(g) + H % 2 / 2,
                        width: h
                    }), x = p + b + a / 2 - .5, this.scrollbarRifles.attr({
        ...
        addEvents: function() {
            var e, a = this.chart.container, b = this.mouseDownHandler, c = this.mouseMoveHandler, d = this.mouseUpHandler;
        ...
        init: function() {
            var c, d, i, k, l, a = this, b = a.chart, e = a.scrollbarHeight, f = a.navigatorOptions, g = a.height, h = a.top, j = document.body.style, m = a.baseSeries;
            a.mouseDownHandler = function(d) {
                var v, d = b.pointer.normalize(d), e = a.zoomedMin, f = a.zoomedMax, h = a.top, k = a.scrollbarHeight, m = a.scrollerLeft, n = a.scrollerWidth, o = a.navigatorLeft, p = a.navigatorWidth, q = a.scrollbarPad, r = a.range, s = d.chartX, t = d.chartY, d = b.xAxis[0], w = cb ? 10 : 7;
                if (t > h && h + g + k > t) if ((h = !a.scrollbarEnabled || h + g > t) && w > V.abs(s - e - o)) a.grabbedLeft = !0, 
                a.otherHandlePos = f, a.fixedExtreme = d.max, b.fixedRange = null; else if (h && w > V.abs(s - f - o)) a.grabbedRight = !0, 
                a.otherHandlePos = e, a.fixedExtreme = d.min, b.fixedRange = null; else if (s > o + e - q && o + f + q > s) {
                    a.grabbedCenter = s;
                    a.fixedWidth = r;
                    b.renderer.isSVG && (l = j.cursor, j.cursor = "ew-resize");
                    i = s - e;
                } else if (s > m && m + n > s) {
                    f = h ? s - o - r / 2 : o > s ? e - .2 * r : s > m + n - k ? e + .2 * r : o + e > s ? e - r : f;
                    0 > f ? f = 0 : f + r >= p && (f = p - r, v = c.dataMax);
                    f !== e && (a.fixedWidth = r, e = c.toFixedRange(f, f + r, null, v), d.setExtremes(e.min, e.max, !0, !1, {
                        trigger: "navigator"
                    }));
                }
            };
            a.mouseMoveHandler = function(c) {
                var l, d = a.scrollbarHeight, e = a.navigatorLeft, f = a.navigatorWidth, g = a.scrollerLeft, h = a.scrollerWidth, j = a.range;
                0 !== c.pageX && (c = b.pointer.normalize(c), l = c.chartX, e > l ? l = e : l > g + h - d && (l = g + h - d), 
                a.grabbedLeft ? (k = !0, a.render(0, 0, l - e, a.otherHandlePos)) : a.grabbedRight ? (k = !0, 
                a.render(0, 0, a.otherHandlePos, l - e)) : a.grabbedCenter && (k = !0, i > l ? l = i : l > f + i - j && (l = f + i - j), 
                a.render(0, 0, l - i, l - i + j)), k && a.scrollbarOptions.liveRedraw && setTimeout(function() {
                    a.mouseUpHandler(c);
                }, 0));
            };
            a.mouseUpHandler = function(d) {
                var e, f;
                if (k) {
                    a.zoomedMin === a.otherHandlePos ? e = a.fixedExtreme : a.zoomedMax === a.otherHandlePos && (f = a.fixedExtreme);
                ...
                "mousemove" !== d.type && (a.grabbedLeft = a.grabbedRight = a.grabbedCenter = a.fixedWidth = a.fixedExtreme = a.otherHandlePos = k = i = null, 
                j.cursor = l || "");
            };
            ...
            a.navigatorEnabled ? (a.xAxis = c = new L(b, y({
                ...
                index: p,
                zoomEnabled: !1
            })), m || f.series.data ? a.addBaseSeries() : 0 === b.series.length && O(b, "redraw", function(c, d) {
                b.series.length > 0 && !a.series && (a.setBaseSeries(), b.redraw = c);
                c.call(b, d);
            })) : a.xAxis = c = {
            ...
            O(b, "getMargins", function(b) {
                ...
                b.call(this);
                a.top = h = a.navigatorOptions.top || this.chartHeight - a.height - a.scrollbarHeight - this.spacing[2] - ("bottom" === f.verticalAlign && f.enabled && !f.floating ? e.legendHeight + o(f.margin, 10) : 0);
        ...
        addBaseSeries: function() {
            ...
            a && this.navigatorOptions.adaptToUpdatedData !== !1 && (A(a, "updatedData", this.updatedDataHandler), 
            a.userOptions.events = v(a.userOptions.event, {
                updatedData: this.updatedDataHandler
            }));
        },
        updatedDataHandler: function() {
            var i, k, j, l, m, a = this.chart.scroller, b = a.baseSeries, c = b.xAxis, d = c.getExtremes(), e = d.min, f = d.max, g = d.dataMin, d = d.dataMax, h = f - e, n = a.series;
            i = n.xData;
            var o = !!c.setExtremes;
    ...
    O(va.prototype, "init", function(a, b, c) {
        A(this, "beforeRender", function() {
            var a = this.options;
            (a.navigator.enabled || a.scrollbar.enabled) && (this.scroller = new yb(this));
        });
        a.call(this, b, c);
    });
    O(K.prototype, "addPoint", function(a, b, c, d, e) {
    ...
    zb.prototype = {
        clickButton: function(a, b) {
            var l, t, c = this, d = c.selected, e = c.chart, f = c.buttons, g = c.buttonOptions[a], h = e.xAxis[0], i = e.scroller && e.scroller.getUnionExtremes() || h || {}, k = i.dataMin, j = i.dataMax, m = h && s(z(h.max, o(j, h.max))), n = new Date(m), p = g.type, u = g.count, i = g._range;
            if (!(null === k || null === j || a === c.selected)) {
                if ("month" === p || "year" === p) l = {
                    month: "Month",
                    year: "FullYear"
                }[p], n["set" + l](n["get" + l]() - u), l = n.getTime(), k = o(k, Number.MIN_VALUE), 
                isNaN(l) || k > l ? (l = k, m = z(l + i, j)) : i = m - l; else if (i) l = w(m - i, k), 
                m = z(l + i, j); else if ("ytd" === p) {
                    if (!h) {
                    ...
                    j === r && (k = Number.MAX_VALUE, j = Number.MIN_VALUE, q(e.series, function(a) {
                        a = a.xData;
                        k = z(a[0], k);
                        j = w(a[a.length - 1], j);
                    }), b = !1);
        ...
        updateButtonStates: function(a) {
            ...
            q(b.buttonOptions, function(a, c) {
                var e = a._range, m = e > g - f, n = d.minRange > e, o = "all" === a.type && d.max - d.min >= g - f && 2 !== i[c].state, q = "ytd" === a.type && ua("%Y", f) === ua("%Y", g);
                e === s(d.max - d.min) && c !== h ? (b.setSelected(c), i[c].setState(2)) : m || n || o || q ? i[c].setState(3) : 3 === i[c].state && i[c].setState(0);
            });
        },
        ...
        drawInput: function(a) {
            var i, k, j, b = this, c = b.chart, d = c.renderer.style, e = c.renderer, f = c.options.rangeSelector, g = b.div, h = "min" === a, l = this.inputGroup;
            ...
            i.onchange = function() {
                ...
                isNaN(d) || (F.global.useUTC || (d += 6e4 * new Date().getTimezoneOffset()), h ? d > b.maxInput.HCTime ? d = r : g > d && (d = g) : b.minInput.HCTime > d ? d = r : d > j && (d = j), 
        ...
        render: function(a, b) {
            var r, c = this, d = c.chart, e = d.renderer, f = d.container, g = d.options, h = g.exporting && g.navigation && g.navigation.buttonOptions, i = g.rangeSelector, k = c.buttons, g = F.lang, j = c.div, j = c.inputGroup, l = i.buttonTheme, m = i.inputEnabled !== !1, n = l && l.states, p = d.plotLeft;
            !c.rendered && (c.zoomText = e.text(g.rangeSelectorZoom, p, d.plotTop - 20).css(i.labelStyle).add(), 
            r = p + c.zoomText.getBBox().width + 5, q(c.buttonOptions, function(a, b) {
                ...
                height: 0,
                zIndex: 1
            }), f.parentNode.insertBefore(j, f), c.inputGroup = j = e.g("input-group").add(), 
            j.offset = 0, c.drawInput("min"), c.drawInput("max"));
            m && (f = d.plotTop - 45, j.align(v({
                y: f,
                width: j.offset,
                x: h && (h.y || 0) + h.height - d.spacing[0] > f ? -40 : 0
    ...
    O(va.prototype, "init", function(a, b, c) {
        A(this, "init", function() {
            this.options.rangeSelector.enabled && (this.rangeSelector = new zb(this));
        });
        a.call(this, b, c);
    });
    P.RangeSelector = zb;
    ...
    P.StockChart = function(a, b) {
        var d, c = a.series, e = o(a.navigator && a.navigator.enabled, !0) ? {
            startOnTick: !1,
            endOnTick: !1
        } : null, f = {
            marker: {
    ...
    O(L.prototype, "autoLabelAlign", function(a) {
        if (this.chart.options._stock && "yAxis" === this.coll && 0 === wa(this, this.chart.yAxis)) {
    ...
    L.prototype.getPlotLinePath = function(a, b, c, d, e) {
        var l, m, n, p, v, w, f = this, g = this.isLinked && !this.series ? this.linkedParent.series : this.series, h = f.chart, i = h.renderer, k = f.left, j = f.top, r = [];
        ...
        isNaN(e) || (f.horiz ? q(w, function(a) {
            ...
            p = m + a.len;
            l = n = s(e + f.transB);
            (l >= k && k + f.width >= l || d) && r.push("M", l, m, "L", n, p);
        }) : q(w, function(a) {
            l = a.left;
            n = l + a.width;
            m = p = s(j + f.height - e);
            (m >= j && j + f.height >= m || d) && r.push("M", l, m, "L", n, p);
        }));
    ...
    L.prototype.getPlotBandPath = function(a, b) {
        ...
        if (d && c) for (f = 0; d.length > f; f += 6) e.push("M", d[f + 1], d[f + 2], "L", d[f + 4], d[f + 5], c[f + 4], c[f + 5], c[f + 1], c[f + 2]); else e = null;
        return e;
    };
    ka.prototype.crispPolyLine = function(a, b) {
        var c;
        for (c = 0; a.length > c; c += 6) a[c + 1] === a[c + 4] && (a[c + 1] = a[c + 4] = s(a[c + 1]) - b % 2 / 2), 
        a[c + 2] === a[c + 5] && (a[c + 2] = a[c + 5] = s(a[c + 2]) + b % 2 / 2);
        return a;
    };
    Wa === P.VMLRenderer && (fb.prototype.crispPolyLine = ka.prototype.crispPolyLine);
    O(L.prototype, "hideCrosshair", function(a, b) {
        a.call(this, b);
        t(this.crossLabelArray) && (t(b) ? this.crossLabelArray[b] && this.crossLabelArray[b].hide() : q(this.crossLabelArray, function(a) {
            a.hide();
        }));
    });
    O(L.prototype, "drawCrosshair", function(a, b, c) {
        ...
        if (t(this.crosshair.label) && this.crosshair.label.enabled && t(c)) {
            var l, m, a = this.chart, f = this.options.crosshair.label, g = this.isXAxis ? "x" : "y", b = this.horiz, h = this.opposite, i = this.left, k = this.top, j = this.crossLabel, n = f.format, p = "";
            j || (j = this.crossLabel = a.renderer.label().attr({
                align: f.align || (b ? "center" : h ? "right" === this.labelAlign ? "right" : "left" : "left" === this.labelAlign ? "left" : "center"),
                zIndex: 12,
                height: b ? 16 : r,
            ...
            b ? (l = c.plotX + i, m = k + (h ? 0 : this.height)) : (l = h ? this.width + i : 0, 
            m = c.plotY + k);
            if (k > m || m > k + this.height) this.hideCrosshair(); else {
                ...
                c = j.getBBox();
                b ? ("inside" === this.options.tickPosition && !h || "inside" !== this.options.tickPosition && h) && (m = j.y - c.height) : m = j.y - c.height / 2;
                b ? (d = i - c.x, e = i + this.width - c.x) : (d = "left" === this.labelAlign ? i : 0, 
                e = "right" === this.labelAlign ? i + this.width : a.chartWidth);
                d > j.translateX && (l += d - j.translateX);
    ...
    var mc = ba.init, nc = ba.processData, oc = za.prototype.tooltipFormatter;
    ba.init = function() {
    ...
    ba.setCompare = function(a) {
        this.modifyValue = "value" === a || "percent" === a ? function(b, c) {
            ...
            b !== r && (b = "value" === a ? b - d : b = 100 * (b / d) - 100, c) && (c.change = b);
            return b;
        } : null;
    ...
    ba.processData = function() {
        ...
        if (this.xAxis && this.processedYData) {
            ...
            for (d = c.length; d > a; a++) if ("number" == typeof c[a] && b[a] >= this.xAxis.min) {
    ...
    O(K.prototype, "render", function(a) {
        this.isCartesian && this.chart.options._stock && (this.clipBox ? this.chart[this.sharedClipKey] && this.chart[this.sharedClipKey].attr({
            width: this.xAxis.len,
            height: this.yAxis.len
        }) : (this.clipBox = y(this.chart.clipBox), this.clipBox.width = this.xAxis.len, 
