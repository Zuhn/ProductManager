(function(g) {
    ...
    var t = function() {}, o = g.getOptions(), i = g.each, p = g.extend, x = g.format, q = g.wrap, l = g.Chart, n = g.seriesTypes, u = n.pie, m = n.column, v = HighchartsAdapter.fireEvent, y = HighchartsAdapter.inArray;
    p(o.lang, {
    ...
    l.prototype.addSingleSeriesAsDrilldown = function(a, b) {
        var h, d = a.series, c = d.xAxis, f = d.yAxis;
        h = a.color || d.color;
        var e, k, w = [], g = [];
        k = d.levelNumber || 0;
        b = p({
        ...
        i(d.chart.series, function(a) {
            a.xAxis === c && (w.push(a), g.push(a.userOptions), a.levelNumber = a.levelNumber || 0);
        });
        h = {
            levelNumber: k,
        ...
        h.levelNumber = k + 1;
        c && (c.oldPos = c.pos, c.userMin = c.userMax = null, f.userMin = f.userMax = null);
        d.type === h.type && (h.animate = h.animateDrilldown || t, h.options.animation = !0);
    };
    ...
    l.prototype.showDrillUpButton = function() {
        var c, f, a = this, b = this.getDrilldownBackText(), d = a.options.drilldown.drillUpButton;
    ...
    l.prototype.drillUp = function() {
        for (var e, g, j, k, a = this, b = a.drilldownLevels, d = b[b.length - 1].levelNumber, c = b.length, f = a.series, h = f.length, l = function(b) {
            var c;
            i(f, function(a) {
                a.userOptions === b && (c = a);
            });
            c = c || a.addSeries(b, !1);
            c.type === g.type && c.animateDrillupTo && (c.animate = c.animateDrillupTo);
            ...
            j.type === g.type && (j.drilldownLevel = e, j.options.animation = a.options.drilldown.animation, 
            g.animateDrillupFrom && g.animateDrillupFrom(e));
            j.levelNumber = d;
            g.remove(!1);
            j.xAxis && (k = e.oldExtremes, j.xAxis.setExtremes(k.xMin, k.xMax, !1), j.yAxis.setExtremes(k.yMin, k.yMax, !1));
        }
        this.redraw();
        ...
        if (!a) {
            ...
            setTimeout(function() {
                i(b.points, function(a, b) {
                    var h = b === (d && d.pointIndex) ? "show" : "fadeIn", e = "show" === h ? !0 : void 0;
                    a.graphic[h](e);
                    a.dataLabel && a.dataLabel[h](e);
                    a.connector && a.connector[h](e);
                });
    ...
    m.prototype.animateDrilldown = function(a) {
        ...
        a || (i(d, function(a) {
            b.userOptions === a.lowerSeriesOptions && (c = a.shapeArgs);
    ...
    m.prototype.animateDrillupFrom = function(a) {
        ...
        i(this.points, function(c) {
            ...
            h && (delete c.graphic, b ? h.animate(a.shapeArgs, g.merge(b, {
                step: function(a, b) {
                    "start" === b.prop && 4 === e.length && 4 === i.length && this.attr({
                        fill: s(e, i, b.pos)
                    });
                },
                complete: j
    ...
    g.Point.prototype.doDrilldown = function(a) {
        for (var f, b = this.series.chart, d = b.options.drilldown, c = (d.series || []).length; c-- && !f; ) d.series[c].id === this.drilldown && (f = d.series[c]);
        v(b, "drilldown", {
            point: this,
            seriesOptions: f
        });
    ...
    q(g.Point.prototype, "init", function(a, b, d, c) {
        ...
        if (f.drilldown) {
            if (g.addEvent(f, "click", function() {
                ...
                e._basicStyle || (e._basicStyle = e.element.getAttribute("style"));
