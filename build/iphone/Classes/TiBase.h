...
// in simulator we redefine to format for MademoiselleCharlotteAdmin Developer console
...
{\
	NSString * exceptionName = [@"org.mademoisellecharlotteadmin." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.mademoisellecharlotteadmin";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMademoiselleCharlotteAdminNativeItemNone = -1, 
	UIMademoiselleCharlotteAdminNativeItemSpinner = -2,
	UIMademoiselleCharlotteAdminNativeItemProgressBar = -3,
	
	UIMademoiselleCharlotteAdminNativeItemSlider = -4,
	UIMademoiselleCharlotteAdminNativeItemSwitch = -5,
	UIMademoiselleCharlotteAdminNativeItemMultiButton = -6,
	UIMademoiselleCharlotteAdminNativeItemSegmented = -7,
	
	UIMademoiselleCharlotteAdminNativeItemTextView = -8,
	UIMademoiselleCharlotteAdminNativeItemTextField = -9,
	UIMademoiselleCharlotteAdminNativeItemSearchBar = -10,
	
	UIMademoiselleCharlotteAdminNativeItemPicker = -11,
	UIMademoiselleCharlotteAdminNativeItemDatePicker = -12,
	
	UIMademoiselleCharlotteAdminNativeItemInfoLight = -13,
	UIMademoiselleCharlotteAdminNativeItemInfoDark = -14,
	
	UIMademoiselleCharlotteAdminNativeItemDisclosure = -15,
	
	UIMademoiselleCharlotteAdminNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all MademoiselleCharlotteAdmin instances of
