...
//Rare exceptions to indicate a bug in the _mademoisellecharlotteadmin code (Eg, function that a subclass should have implemented)
...
/**
 The base class for MademoiselleCharlotteAdmin proxies.
 */
