...
/**
 Base class for all MademoiselleCharlotteAdmin views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the MademoiselleCharlotteAdmin view hierarchy (such as wrapped iOS UIViews) was touched.
