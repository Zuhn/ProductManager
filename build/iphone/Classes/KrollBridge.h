...
@interface MademoiselleCharlotteAdminObject : KrollCoverageObject {
#else
@interface MademoiselleCharlotteAdminObject : KrollObject {
#endif
@private
...
extern NSString * MademoiselleCharlotteAdmin$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	MademoiselleCharlotteAdminObject *_mademoisellecharlotteadmin;
    KrollObject* console;
	BOOL shutdown;
