...
//@interface MademoiselleCharlotteAdminObject : NSObject
//@end

@interface MademoiselleCharlotteAdminObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[MademoiselleCharlotteAdminObject class]])
		{
			for (NSString *key in [[(MademoiselleCharlotteAdminObject*)o modules] allKeys])
			{
